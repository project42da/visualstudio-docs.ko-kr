...
#### 매개 변수  
 ...
 `object`  
 선택적 요소.  새 클래스가 속성과 메서드를 상속하는 소스 개체 또는 클래스입니다.  
  
 `constructor`  
 선택적 요소.  새 클래스 인스턴스를 초기화하는 생성자 함수입니다.  
  
 `arg1...argN`  
 선택적 요소.  함수가 인식하는 선택적, 쉼표로 구분된 인수 목록입니다.  
  
 `statements`  
 선택적 요소.  하나 이상의 [!INCLUDE[javascript](../../javascript/includes/javascript-md.md)] 문입니다.  
  
 `static`  
 선택적 요소.  정적 메서드를 지정합니다.  
  
 `method`  
 선택적 요소.  클래스 인스턴스에서 호출될 수 있는 하나 이상의 [!INCLUDE[javascript](../../javascript/includes/javascript-md.md)] 인스턴스 또는 정적 메서드입니다.  
