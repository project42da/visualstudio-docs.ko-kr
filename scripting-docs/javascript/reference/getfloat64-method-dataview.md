...
---
# getFloat64 메서드(DataView)
뷰의 시작 지점에서 지정된 오프셋 바이트 수만큼 Float64 값을 가져옵니다.  맞춤 제약 조건이 없습니다. 멀티바이트 값은 모든 오프셋에서 페치될 수 있습니다.  
...
## 예제  
 다음 예제에서는 DataView에서 첫 번째 Float64를 가져오는 방법을 보여 줍니다.  
