...
---
# rightContext 속성($&#39;)(RegExp)(JavaScript)
마지막으로 일치하는 문자열 다음부터 검색한 문자열 끝까지의 문자를 반환합니다.  읽기 전용입니다.  
 ...
 **rightContext** 속성의 초기 값은 빈 문자열입니다.  **rightContext** 속성 값은 일치하는 값을 찾을 때마다 변경됩니다.  
  
## 예제  
 다음 예제는 **rightContext** 속성의 사용법을 보여 줍니다.  
