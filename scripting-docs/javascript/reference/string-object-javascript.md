---
title: "String 개체(JavaScript) | Microsoft Docs"
ms.custom: ""
ms.date: "01/18/2017"
...
---
# String 개체(JavaScript)
텍스트 문자열을 조작하고 형식을 지정하거나 문자열 안에서 부분 문자열을 결정하고 위치를 지정할 수 있게 합니다.  
...
## 문자열 리터럴  
 *문자열 리터럴*은 작은따옴표 또는 큰따옴표로 묶인 0개 이상의 문자입니다.  문자열 리터럴은 `string`의 기본 데이터 형식입니다.  *문자열 개체*는 [new 연산자](../../javascript/reference/new-operator-decrementjavascript.md)를 사용하여 만들어지며 `Object` 데이터 형식을 갖습니다.  
...
|[String.raw 함수](../../javascript/reference/string-raw-function-javascript.md)|원시 문자열 형식의 템플릿 문자열을 반환합니다.|  
...
|[big 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 HTML \<BIG\> 태그를 삽입합니다.|  
|[blink 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 HTML \<BLINK\> 태그를 삽입합니다.|  
|[bold 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 HTML \<B\> 태그를 삽입합니다.|  
...
|[fixed 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 HTML \<TT\> 태그를 삽입합니다.|  
|[fontcolor 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 COLOR 특성을 가진 HTML \<FONT\> 태그를 삽입합니다.|  
|[fontsize 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 SIZE 특성을 가진 HTML \<FONT\> 태그를 삽입합니다.|  
...
|[italics 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 HTML \<I\> 태그를 삽입합니다.|  
...
|[match 메서드](../../javascript/reference/match-method-string-javascript.md)|주어진 **Regular Expression** 개체를 사용하여 문자열을 검색하고 그 결과를 배열로 반환합니다.|  
|[normalize 메서드](../../javascript/reference/normalize-method-string-javascript.md)|유니코드 정규화 형식의 지정된 문자열을 반환합니다.|  
...
|[small 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 HTML \<SMALL\> 태그를 삽입합니다.|  
...
|[strike 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 HTML \<STRIKE\> 태그를 삽입합니다.|  
|[sub 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 HTML \<SUB\> 태그를 삽입합니다.|  
...
|[sup 메서드](../../javascript/reference/html-tag-methods-javascript.md)|텍스트 양 끝에 HTML \<SUP\> 태그를 삽입합니다.|  
