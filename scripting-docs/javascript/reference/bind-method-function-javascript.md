...
dev_langs: 
  ...
  - "DHTML"
helpviewer_keywords: 
  - "인수[JavaScript], bind 메서드"
  - "bind 메서드[JavaScript]"
  - "매개 변수[JavaScript], bind 메서드"
  - "this 키워드[JavaScript], bind 메서드"
...
## 반환 값  
 `thisArg` 개체 및 초기 인수를 제외하고 `function` 함수와 동일한 새 함수입니다.  
