...
|@\_jscript|항상 true입니다.|  
|@\_jscript\_build|[!INCLUDE[javascript](../../javascript/includes/javascript-md.md)] 스크립팅 엔진의 빌드 번호를 포함합니다.|  
|@\_jscript\_version|major.minor 형식의 [!INCLUDE[javascript](../../javascript/includes/javascript-md.md)] 버전 번호를 포함합니다.|