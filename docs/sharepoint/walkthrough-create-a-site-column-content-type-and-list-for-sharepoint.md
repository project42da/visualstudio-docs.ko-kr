---
title: "연습: SharePoint용 사이트 열, 콘텐츠 형식 및 목록 만들기 | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
14. **속성** 목록에서, **정렬 및 그룹화** 속성을 선택한 다음, 줄임표 버튼 ![가변 매개 변수 아이콘](../sharepoint/media/ellipsisicon.png "가변 매개 변수 아이콘") 을 선택하여 **정렬 및 그룹화** 대화 상자를 표시합니다.  
