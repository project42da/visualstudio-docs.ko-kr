...
### <a name="provide-default-values"></a>기본값을 제공 합니다.
...
## <a name="validate-the-model"></a>모델 유효성 검사
 ...
 BDC 디자이너에 대 한 바로 가기 메뉴를 열고 선택 하 여 모델을 확인할 수 있습니다 **유효성 검사**합니다. 모델 오류를 포함 하는 경우에 표시 됩니다는 **오류 목록**합니다. 목록에서 오류를 두 번 클릭하여 오류가 포함된 코드로 빠르게 커서를 이동할 수 있습니다. 선택할 수 있습니다는 **F8** 또는 **Shift**+**F8** 앞 이나 뒤로 돌립니다 목록에서 오류를 통해 단계를 반복 해 서는 키입니다.  
