...
ms.locfileid: "34765988"
---
# <a name="deploy-publish-and-upgrade-sharepoint-solution-packages"></a>배포 게시 하 고 SharePoint 솔루션 패키지를 업그레이드 합니다.
...
## <a name="publish-packages-to-a-remote-or-local-server"></a>패키지를 원격 또는 로컬 서버에 게시
