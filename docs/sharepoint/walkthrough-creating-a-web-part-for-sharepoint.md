...
#### <a name="to-create-an-empty-sharepoint-project"></a>빈 SharePoint 프로젝트를 만들려면  
...
#### <a name="to-add-a-web-part-to-the-project"></a>프로젝트에 웹 파트를 추가 하려면  
...
#### <a name="to-render-content-in-the-web-part"></a>웹 파트에서 콘텐츠를 렌더링 하려면  
...
#### <a name="to-test-the-web-part"></a>웹 파트를 테스트 하려면  
...
#### <a name="to-test-the-custom-property"></a>사용자 지정 속성을 테스트 하려면  
...
#### <a name="to-test-the-web-part-verb"></a>웹 파트 동사를 테스트 하려면  
