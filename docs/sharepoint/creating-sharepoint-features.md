...
## <a name="adding-features-to-the-sharepoint-solution"></a>SharePoint 솔루션에 기능 추가  
...
## <a name="adding-and-removing-sharepoint-project-items"></a>SharePoint 프로젝트 항목 추가 및 제거  
...
## <a name="adding-feature-dependencies"></a>기능 종속성 추가  
