---
title: "C + + 코어 지침 검사기를 사용 하 여 | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
C + + 코어 지침 검사기에 새 규칙 추가 되 면 기존 코드에 대 한 생성 되는 경고 수가 증가할 수 있습니다. 사용 하도록 설정 하는 규칙의 종류를 필터링 하려면 미리 정의 된 규칙 집합을 사용할 수 있습니다. 대부분의 규칙에 대 한 참조 항목은 [Visual Studio c + + 코어 확인 참조](code-analysis-for-cpp-corecheck.md)합니다.
