...
Visual Studio에서 코드 분석을 구성할 때 Microsoft 기본 제공 목록에서 선택할 수 있습니다 *규칙 집합*합니다. 규칙 집합은 대상된 문제 및 특정 조건을 식별 하는 코드 분석 규칙의 논리적 그룹입니다. 예를 들어 공개적으로 사용할 수 있는 Api에 대 한 코드를 검색 하도록 디자인 된 규칙 집합을 적용할 수 하거나 최소 권장 규칙을 포함 하는 규칙 집합을 적용할 수 있습니다. 또한 모든 규칙을 포함 하는 규칙 집합을 적용할 수 있습니다.
