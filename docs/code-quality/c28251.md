...
경고 C28251: 함수에 대한 주석이 일치하지 않습니다. 이 인스턴스에 오류가 있습니다.  
 ...
 비교는 항상 첫 번째 선언을 찾을 수와 현재 사이입니다.  추가 선언이 있으면 각 선언은 두 그룹에서 확인 됩니다.  현재 쌍에서 이외의 비교를 할 수 없지만 두 개 이상의 선언\/정의를 식별할 수 있습니다.  *text* 필드는 매우 낮은 수준에서 두 인스턴스 간에 다른 \(하위의\) 주석 목록을 포함 합니다.  
