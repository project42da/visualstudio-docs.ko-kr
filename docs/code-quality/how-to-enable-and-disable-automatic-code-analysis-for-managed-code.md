...
2.  프로젝트에 대 한 속성 대화 상자를 클릭 하 여 **코드 분석**합니다.  
  
3.  빌드 형식을 지정 **구성** 에서 대상 플랫폼 및 **플랫폼**합니다.  
  
4.  를 사용 하거나 자동 코드 분석을 사용 하지 않도록 설정 하려면 선택 하거나 선택 취소 된 **코드 빌드에 분석 사용 (CODE_ANALYSIS 상수 정의)** 확인란 합니다.