...
### [C++ 코드에 대한 규칙 집합](using-rule-sets-to-specify-the-cpp-rules-to-run.md)
### [사용자 지정 규칙 집합 만들기](how-to-create-a-custom-rule-set.md)
### [규칙 집합 편집기 사용](working-in-the-code-analysis-rule-set-editor.md)
## [체크 인 정책](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
...
### [프로젝트 규칙 집합을 팀 체크 인 정책과 동기화](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
