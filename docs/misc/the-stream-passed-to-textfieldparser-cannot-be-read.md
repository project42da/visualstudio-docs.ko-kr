...
[TextFieldParser Object](/dotnet/visual-basic/language-reference/objects/textfieldparser-object)는 전달된 스트림을 읽을 수 없습니다. 텍스트 파일이 아닌 파일을 읽으려고 하는 경우 이러한 문제가 발생할 수 있습니다.  
