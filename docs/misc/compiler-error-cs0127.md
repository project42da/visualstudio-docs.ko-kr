...
‘function’이 void를 반환하므로 return 키워드 뒤에 개체 식이 나오면 안 됩니다.  
 ...
 반환 형식이 [void](/dotnet/csharp/language-reference/keywords/void)인 메서드는 값을 반환할 수 없습니다. 자세한 내용은 [메서드](/dotnet/csharp/programming-guide/classes-and-structs/methods)을 참조하세요.  
