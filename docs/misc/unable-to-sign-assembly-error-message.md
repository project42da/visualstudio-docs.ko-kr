...
[!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 컴파일러가 어셈블리 링커\(Al.exe, Alink라고도 함\)를 호출하여 매니페스트를 사용해 어셈블리를 생성합니다. 링커가 만들어진 후에 어셈블리에 서명하는 오류를 보고했습니다. 이는 잘못된 키 때문일 수 있습니다.  
