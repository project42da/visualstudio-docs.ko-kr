...
[!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 컴파일러가 어셈블리 링커\(Al.exe, Alink라고도 함\)를 호출하여 매니페스트를 사용해 어셈블리를 생성합니다. 링커가 파일을 만들거나 메모리 내 리소스를 쓰는 동안 오류를 보고했습니다. 이는 구성 문제 때문일 수 있습니다.  
