...
'event' 이벤트는 \+\= 또는 \-\=의 왼쪽에만 올 수 있습니다.  
 ...
 [이벤트](/dotnet/csharp/language-reference/keywords/event)를 잘못 호출했습니다. 자세한 내용은 [이벤트](/dotnet/csharp/programming-guide/events/index) 및 [대리자](/dotnet/csharp/programming-guide/delegates/index)를 참조하세요.  
