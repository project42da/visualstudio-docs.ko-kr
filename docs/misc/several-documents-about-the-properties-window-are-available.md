...
[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 도움말에는 **속성** 창에 대한 다음 문서가 포함되어 있지만 사용자의 도움말 요청에 가장 적절한 문서가 자동으로 확인되지는 않습니다. 수행하려는 작업과 가장 관련이 높은 문서를 선택하십시오.  
...
|[프로젝트 속성 참조](../ide/reference/project-properties-reference.md)|에 대 한 항목 링크를 제공 합니다.  **프로젝트 디자이너** 페이지입니다.|  
...
|[속성 창](../ide/reference/properties-window.md)|디자인 타임 속성, 프로젝트 속성 및 솔루션 속성을 변경하는 데 사용할 수 있는 **속성** 창에 대해 설명합니다.|