...
-   메서드를 사용자 지정 집계 함수로 추가합니다\(확장 메서드\). 사용자 지정 집계 함수를 만드는 방법에 대한 자세한 내용은 [Aggregate Clause](/dotnet/visual-basic/language-reference/queries/aggregate-clause)를 참조하세요.  
  
## 참고 항목  
 [Aggregate Clause](/dotnet/visual-basic/language-reference/queries/aggregate-clause)   
 [Group By 절](/dotnet/visual-basic/language-reference/queries/group-by-clause)   
