...
---
# 사용자 인터페이스 요소에 대한 연습
VSPackage의 여러 다른 UI\(사용자 인터페이스\) 요소 또는 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] IDE\(통합 개발 환경\)에 메뉴 및 도구 모음을 추가할 수 있습니다. 이 섹션의 연습에서는 가장 일반적인 시나리오를 안내합니다.  
...
## 단원 내용  
 ...
 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] IDE에 도구 모음을 추가하는 방법을 보여 줍니다.  
