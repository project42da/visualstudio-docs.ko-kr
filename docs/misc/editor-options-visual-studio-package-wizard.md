 ...
 **파일 확장명**  
 편집기와 연결된 파일 이름 확장명을 정의합니다. 쉼표로 구분된 목록을 입력하여 여러 확장명을 지정할 수 있습니다. 편집기는 정의한 파일 이름 확장명을 가진 파일에 대한 기본 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 편집기입니다.  
