...
\#endregion 지시문이 필요합니다.  
 ...
 [\#region](/dotnet/csharp/language-reference/preprocessor-directives/preprocessor-region) 지시문에 짝이 맞는 [\#endregion](/dotnet/csharp/language-reference/preprocessor-directives/preprocessor-endregion) 지시문이 없습니다.  
