...
조건식에 할당을 사용하면 항상 상수가 됩니다. \= 대신 \=\=을 사용하세요.  
 ...
 조건식에서 [\=\= 연산자](/dotnet/csharp/language-reference/operators/equality-comparison-operator)가 아닌 [\= 연산자](/dotnet/csharp/language-reference/operators/assignment-operator)를 사용했습니다.  
