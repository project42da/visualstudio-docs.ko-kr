...
[!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 컴파일러에서 내부적으로 작성된 파일 중 하나를 해석할 수 없습니다.  
...
2.  그래도 오류가 다시 발생하면 [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] 컴파일러를 다시 설치합니다.  
