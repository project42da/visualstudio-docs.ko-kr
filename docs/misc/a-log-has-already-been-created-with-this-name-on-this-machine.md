...
## 참고 항목  
 [My.Application.Log 개체](/dotnet/visual-basic/language-reference/objects/my-application-log-object)   
 ...
 [응용 프로그램 로그 작업](/dotnet/visual-basic/developing-apps/programming/log-info/working-with-application-logs)   
