...
| 배포 시나리오 | 지원 내용 |
| --- | --- |  
| **클라우드에 게시:** 가능 응용 프로그램, 서비스 및 데이터에서 사용할 수 있는 Visual Studio를 사용 하 여 Microsoft Azure에 배포 하 여 모든 위치입니다.|[Microsoft Azure에 응용 프로그램 게시](https://docs.microsoft.com/en-us/azure/#pivot=products) |
