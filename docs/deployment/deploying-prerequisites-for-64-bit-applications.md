---
title: "64비트 응용 프로그램의 필수 구성 요소 배포 | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
helpviewer_keywords: 
  - "64비트[Visual Studio]"
  - "64비트 응용 프로그램[Visual Studio]"
  - "64비트 프로그래밍[Visual Studio]"
  - "응용 프로그램 배포[Visual Studio], 64비트"
...
manager: "wpickett"
---
# 64비트 응용 프로그램의 필수 구성 요소 배포
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

ClickOnce 배포에서는 64비트 플랫폼에 응용 프로그램을 설치할 수 있습니다.  대상 플랫폼은 32비트 플랫폼의 경우 **x86**, AMD64\/EM64T 명령 집합을 지원하는 컴퓨터의 경우 **x64**, 64비트 Itanium 프로세서의 경우 **Itanium**입니다.  
