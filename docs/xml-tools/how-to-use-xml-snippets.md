...
> [!NOTE]
>  **조각 삽입** 명령을 바로 가기 키 (CTRL + K를 누르고 CTRL + X)를 통해 사용할 수도 있습니다.  
...
> [!NOTE]
>  **감싸기** 명령을 바로 가기 키 (CTRL + K를 누르고 CTRL + S)를 통해 사용할 수도 있습니다.  
...
## <a name="using-xml-snippets"></a>XML 조각 사용  
 ...
 코드 조각 필드 설정을 수정 하 여 편집할 수 있는 코드 조각 필드에 대 한 기본 색을 변경할 수 있습니다는 **글꼴 및 색** 의 창 고 **옵션**의대화 상자. 자세한 내용은 참조 [하는 방법: 글꼴 및 색 편집기에서 변경](../ide/reference/how-to-change-fonts-and-colors-in-the-editor.md)합니다.  
