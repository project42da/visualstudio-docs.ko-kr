---
title: "XML 리터럴의 XML 스키마 탐색기와의 통합 | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Visual Basic XML 조각을 Visual Basic 코드에 직접 통합할 수 있습니다 의미 하는 XML 리터럴을 지원 합니다. 자세한 내용은 참조 [XML 리터럴 개요](http://go.microsoft.com/fwlink/?LinkId=140325)합니다.  
