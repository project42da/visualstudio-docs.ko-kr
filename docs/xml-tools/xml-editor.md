...
[XSLT IntelliSense](../xml-tools/xml-editor-intellisense-features.md) 및 명명 된 템플릿의 매개 변수 이름이 지정된 모드 또는 지정 된 자동 완성 특성 집합 이름, 템플릿 모드 및 이름에 있습니다.

## <a name="xslt-profiler"></a>XSLT 프로파일러

[XSLT 프로파일러](../xml-tools/walkthrough-xslt-profiler.md) 자세한 XSLT 성능 측정, 평가 및 XSLT 코드의 성능 관련 문제를 대상 하는 데 도움이 되는 보고서를 만듭니다. XSLT 프로파일러에는 XSL 및 XSLT 스타일시트 최적화에 유용한 힌트도 포함되어 있습니다.
