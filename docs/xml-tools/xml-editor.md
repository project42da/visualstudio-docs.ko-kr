...
XML 편집기는 .xml, .xsd, .xsl, .config 등의 잘 알려진 파일 확장명에 대해 호출됩니다. 또한 파일에 XML이 포함된 경우 알려지지 않은 파일 확장명에 대해서도 호출됩니다. 있습니다도 파일을 열 수는 XML 편집기를 사용 하 여는 **연결** 옵션을 목록에서 XML 편집기를 선택 합니다.  
...
## <a name="related-sections"></a>관련 단원  
 [텍스트, 코드 및 태그를 편집합니다.](http://msdn.microsoft.com/en-us/0d9c00d7-5df4-48a3-b185-2a265f055439)  
