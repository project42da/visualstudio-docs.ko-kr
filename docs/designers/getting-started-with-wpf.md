...
|Windows Forms 개발자인가요?|[Windows Forms 컨트롤 및 해당 WPF 컨트롤](https://msdn.microsoft.com/en-us/library/ms750559\(v=vs.100\).aspx)<br /><br /> [WPF 및 Windows Forms 상호 운용성에서 지원되는 시나리오](https://msdn.microsoft.com/en-us/library/ms751797\(v=vs.100\).aspx)|  
  
## <a name="see-also"></a>참고 항목  
 [클래스 라이브러리(WPF)](https://msdn.microsoft.com/en-us/library/ms753307\(v=vs.100\).aspx)   
