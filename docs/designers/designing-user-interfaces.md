...
|자세한 정보를 확인할 항목|참조|  
|-------------------------|---------|  
|Visual Studio 또는 Blend for Visual Studio를 사용하여 XAML 기반 앱 또는 응용 프로그램 디자인.   를 클릭합니다.|[Visual Studio 및 Blend for Visual Studio에서 XAML 디자인](../designers/designing-xaml-in-visual-studio.md)|  
