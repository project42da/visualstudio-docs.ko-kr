...
IDE(통합 개발 환경) [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]의 **성능 탐색기** 창에서는 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 프로파일링 도구를 사용하여 성능 세션을 구성 및 시작할 수 있습니다.  
