---
title: "프로파일러 공통 데이터 뷰 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
이 단원에는 모든 프로파일링 방법에 공통적으로 적용되는 프로파일러 데이터 파일의 뷰 및 보고서에 대한 참조 정보가 포함되어 있습니다.  
  
## 단원 내용  
 [요약 뷰](../profiling/summary-view.md)  
 요약 뷰 및 보고서에 대해 설명합니다.  데이터 열은 프로파일링 방법에 따라 달라집니다.  
  
 [호출자\/호출 수신자 뷰](../profiling/caller-callee-view.md)  
 호출 트리 뷰 및 보고서에 대해 설명합니다.  데이터 열은 프로파일링 방법에 따라 달라집니다.  
  
 [호출 트리 뷰](../profiling/call-tree-view.md)  
 호출 트리 뷰 및 보고서에 대해 설명합니다.  데이터 열은 프로파일링 방법에 따라 달라집니다.  
  
 [모듈 뷰](../profiling/modules-view.md)  
 모듈 뷰 및 보고서에 대해 설명합니다.  데이터 열은 프로파일링 방법에 따라 달라집니다.  
  
 [함수 뷰](../profiling/functions-view.md)  
 함수 뷰 및 보고서에 대해 설명합니다.  데이터 열은 프로파일링 방법에 따라 달라집니다.  
  
 [줄 뷰](../profiling/lines-view.md)  
 줄 뷰 및 보고서에 대해 설명합니다.  데이터 열은 프로파일링 방법에 따라 달라집니다.  
  
 [IP\(명령 포인터\) 뷰](../profiling/instruction-pointers-ips-view.md)  
 IP\(명령 포인터\) 뷰 및 보고서에 대해 설명합니다.  데이터 열은 프로파일링 방법에 따라 달라집니다.  
...
## 관련 단원  
 ...
 .NET 메모리 할당을 사용하여 생성된 프로파일러 데이터 파일의 뷰 및 보고서에 대한 참조 정보입니다.