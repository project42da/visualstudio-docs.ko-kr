...
![진단 도구](../profiling/media/prof-tour-diagnostic-tools.png "진단 도구")

디버그하는 동안 **진단 도구** 창을 사용하여 CPU 및 메모리 사용을 분석하고 성능 관련 정보를 보여주는 이벤트를 확인할 수 있습니다.

![진단 도구 요약](../profiling/media/prof-tour-cpu-and-memory-graph.gif "진단 도구 요약")
...
![진단 도구 CPU 사용량 사용](../profiling/media/prof-tour-enable-cpu-profiling.png "진단 도구 CPU 사용량 사용")
...
![진단 도구 CPU 사용량](../profiling/media/prof-tour-cpu-usage.png "진단 도구 CPU 사용량")

원하는 함수를 두 번 클릭하면 세 개의 창으로 구분된 세부 보기가 표시되고, 창의 가운데 선택된 함수가 표시되고, 왼쪽에 호출 중인 함수, 오른쪽에 호출된 함수가 표시됩니다. **함수 본문** 섹션에는 또한 호출 함수 및 호출된 함수에 사용된 시간을 제외하고 함수 본문에 사용된 총 시간(및 시간의 백분율)이 표시됩니다. 이 데이터를 사용하여 함수 자체에 성능 병목 현상이 있는지 여부를 평가할 수 있습니다.

![진단 도구 호출자 호출 수신자 뷰](../profiling/media/prof-tour-cpu-usage-caller-callee.png "진단 도구 호출자 호출 수신자 뷰")
...
![진단 도구 스냅숏 만들기](../profiling/media/prof-tour-take-snapshots.gif "진단 도구 스냅숏 만들기")
...
![진단 도구 이벤트 보기](../profiling/media/prof-tour-events.png "진단 도구 이벤트 보기")
...
![진단 도구 UI 분석 이벤트 보기](../profiling/media/prof-tour-ui-analysis.png "진단 도구 UI 분석 이벤트 보기")
...
![프로파일링 둘러보기 응용 프로그램 타임라인](../profiling/media/prof-tour-application-timeline.gif "프로파일링 둘러보기 응용 프로그램 타임라인")
...
![대화 상자 GPU 사용량](../profiling/media/prof-tour-gpu-usage.png "대화 상자 GPU 사용량")
...
![대화 상자 네트워크 사용량](../profiling/media/prof-tour-network-usage.png "대화 상자 네트워크 사용량")

요약 뷰에서 작업을 선택하여 세부 정보를 확인할 수 있습니다.

![대화 상자 네트워크 사용량 세부 정보](../profiling/media/prof-tour-network-usage-details.png "대화 상자 네트워크 사용량 세부 정보")
...
![성능 탐색기](../profiling/media/prof-tour-performance-explorer.png "성능 탐색기")
