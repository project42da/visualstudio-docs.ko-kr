...
![진단 도구 창](~/docs/profiling/media/prof-tour-diagnostic-tools.png "진단 도구")

디버그하는 동안 **진단 도구** 창을 사용하여 CPU 및 메모리 사용을 분석하고 성능 관련 정보를 보여주는 이벤트를 확인할 수 있습니다.

![진단 도구 요약 뷰](~/docs/profiling/media/prof-tour-cpu-and-memory-graph.gif "진단 도구 요약")
...
![진단 도구에서 CPU 사용량 사용](~/docs/profiling/media/prof-tour-enable-cpu-profiling.png "진단 도구 CPU 사용량 사용")
...
![진단 도구 CPU 사용량 뷰](~/docs/profiling/media/prof-tour-cpu-usage.png "진단 도구 CPU 사용량")
...
![진단 도구 호출자 호출 수신자 "나비" 뷰](~/docs/profiling/media/prof-tour-cpu-usage-caller-callee.png "진단 도구 호출자 호출 수신자 뷰")
...
![진단 도구에서 스냅숏 만들기](~/docs/profiling/media/prof-tour-take-snapshots.gif "진단 도구 스냅숏 만들기")

화살표 링크 중 하나를 선택하면 힙의 차이 뷰(빨간색 위쪽 화살표 ![메모리 사용량 증가](~/docs/profiling/media/prof-tour-mem-usage-up-arrow.png "메모리 사용량 증가")는 증가하는 개체 수(왼쪽)와 증가하는 힙 크기(오른쪽) 표시)가 제공됩니다. 오른쪽 링크를 클릭하면 힙 크기가 가장 많이 증가한 개체순으로 차이 힙 뷰가 표시됩니다. 여기서 메모리 문제를 파악할 수 있습니다. 예를 들어 아래 그림에서 `ClassHandlersStore` 개체에 사용된 바이트 수가 두 번째 스냅숏에서 3,492바이트 증가했습니다.

![진단 도구 힙 차이 뷰](~/docs/profiling/media/prof-tour-mem-usage-diff-heap.png "진단 도구 힙 차이 뷰")
...
![진단 도구 이벤트 뷰](~/docs/profiling/media/prof-tour-events.png "도구 진단 이벤트 뷰")
...
![프로파일링 둘러보기 PerfTips](~/docs/profiling/media/prof-tour-perf-tips.png "프로파일링 둘러보기 PerfTips")
...
![진단 도구에서 UI 분석 이벤트 보기](~/docs/profiling/media/prof-tour-ui-analysis.png "진단 도구 UI 분석 이벤트 보기")
...
![성능 프로파일러](~/docs/profiling/media/prof-tour-performance-profiler.png "성능 프로파일러")
...
![응용 프로그램 타임라인 프로파일링](~/docs/profiling/media/prof-tour-application-timeline.gif "프로파일링 둘러보기 응용 프로그램 타임라인")
...
![GPU 사용량 프로파일링 도구](~/docs/profiling/media/prof-tour-gpu-usage.png "GPU 사용량 진단")
...
![네트워크 사용량 프로파일링 도구](~/docs/profiling/media/prof-tour-network-usage.png "네트워크 사용량 진단")

요약 뷰에서 작업을 선택하여 세부 정보를 확인할 수 있습니다.

![네트워크 사용량 도구의 세부 정보](~/docs/profiling/media/prof-tour-network-usage-details.png "네트워크 사용량 세부 정보 진단")
...
![성능 탐색기 도구](~/docs/profiling/media/prof-tour-performance-explorer.png "성능 탐색기")
