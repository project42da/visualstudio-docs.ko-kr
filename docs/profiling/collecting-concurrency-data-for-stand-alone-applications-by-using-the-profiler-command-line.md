...
manager: "ghogen"
---
# 프로파일러 명령줄을 사용하여 독립 실행형 응용 프로그램에 대한 동시성 데이터 수집
...
|**실행 중인 .NET Framework 응용 프로그램에 프로파일러를 연결합니다.**|-   [방법: .NET Framework 응용 프로그램에 프로프일러를 연결하여 동시성 데이터 수집](../Topic/How%20to:%20Attach%20the%20Profiler%20to%20a%20.NET%20Framework%20Stand-Alone%20Application%20to%20Collect%20Concurrency%20Data%20by%20Using%20the%20Command%20Line.md)|  
|**실행 중인 C\/C\+\+ 응용 프로그램에 프로파일러 연결**|-   [방법: 네이티브 응용 프로그램에 프로파일러 연결 및 동시성 데이터 수집](../Topic/How%20to:%20Attach%20the%20Profiler%20to%20a%20Native%20Stand-Alone%20Application%20and%20Collect%20Concurrency%20Data%20by%20Using%20the%20Command%20Line.md)|  
