...
## <a name="lock-contention-and-serialized-execution"></a>잠금 경합 및 직렬화된 실행  
 ![잠금 경합으로 인해 발생하는 직렬화된 실행](~/docs/profiling/media/lockcontention_serialized.png "LockContention_Serialized")  
 ...
 ![잠금 경합](~/docs/profiling/media/lockcontention_2.png "LockContention_2")  
  
## <a name="uneven-workload-distribution"></a>균등하지 않은 작업 부하 분산  
 ![균등하지 않은 작업 부하](~/docs/profiling/media/unevenworkload_1.png "UnevenWorkLoad_1")  
 ...
 ![균등하지 않은 작업 부하](~/docs/profiling/media/unevenworkload_2.png "UnevenWorkload_2")  
  
## <a name="oversubscription"></a>초과 구독  
 ![초과 구독](~/docs/profiling/media/oversubscription.png "초과 구독")  
...
## <a name="inefficient-io"></a>불충분한 I/O  
 ![불충분한 I/O](~/docs/profiling/media/inefficient_io.png "Inefficient_IO")  
...
## <a name="lock-convoys"></a>잠금 호송  
 ![잠금 호송](~/docs/profiling/media/lock_convoys.png "Lock_Convoys")  
