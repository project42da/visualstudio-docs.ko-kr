...
![Azure Portal에서 웹 소켓을 사용하도록 설정](~/docs/python/media/azure-remote-debugging-enable-web-sockets.png)
...
![Azure App Service 웹 사이트 디버깅](~/docs/python/media/azure-remote-debugging-attached.png)
...
![Azure 원격 디버깅 프록시 정보 페이지](~/docs/python/media/azure-remote-debugging-proxy-info-page.png)
...
![Azure App Service에서 디버거 끝점 확인](~/docs/python/media/azure-remote-debugging-secret.png)
...
![프로세스에 연결 대화 상자로 Azure 웹 사이트에 연결](~/docs/python/media/azure-remote-debugging-manual-attach.png)
