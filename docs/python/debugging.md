...
![Visual Studio의 중단점](~/docs/python/media/debugging-breakpoints.png)
...
![중단점이 있는 추적점 만들기](~/docs/python/media/debugging-tracepoint.png)
...
![디버거의 DataTips](~/docs/python/media/debugging-quick-tips.png)

[자동] 창(**디버그 > 창 > 자동**)에는 현재 문에 가까운 변수와 식이 포함되어 있습니다. 값 열을 두 번 클릭하거나 선택하고 F2 키를 눌러 값을 편집할 수 있습니다.

![디버거의 자동 창](~/docs/python/media/debugging-autos-window.png)

[지역] 창(**디버그 > 창 > 지역**)에는 현재 범위에 있는 모든 변수가 표시되며 다시 편집될 수 있습니다.

![디버거의 지역 창](~/docs/python/media/debugging-locals-window.png)
...
![디버거의 조사식 창](~/docs/python/media/debugging-watch-window.png)
...
![문자열 시각화 도우미](~/docs/python/media/debugging-string-visualizers.png)
...
![예외 팝업](~/docs/python/media/debugging-exception-popup.png)
...
![예외 창](~/docs/python/media/debugging-exception-settings.png)
...
![프로젝트 디버그 속성](~/docs/python/media/debugging-project-properties.png)
...
![Python 대화형 디버그 창](~/docs/python/media/debugging-interactive.png)
...
![대화형 디버그 창 옵션](~/docs/python/media/debugging-interactive-options.png)
