...
![멤버 완성](~/python/media/code-editing-completions-simple.png)
...
![필터링을 통한 멤버 완성](~/python/media/code-editing-completion-filtering.png)
...
![여러 형식의 멤버 완성](~/python/media/code-editing-completion-types.png)
...
![서명 도움말](~/python/media/code-editing-signature-help.png)
...
![요약 정보](~/python/media/code-editing-quick-info.png)
...
![코드 색 지정](~/python/media/code-editing-code-coloring.png)

사용되는 색을 사용자 지정하려면 **도구 > 옵션 > 환경 > 글꼴 및 색**으로 이동하여 **항목 표시** 목록에서 Python 항목을 수정합니다.

![글꼴 및 색 옵션](~/python/media/code-editing-customize-colors.png)
...
![코드 조각](~/python/media/code-editing-code-snippets.png)

언어로 **Python**을 선택하여 코드 조각 관리자(**도구 > 코드 조각 관리자**)에서 사용 가능한 코드 조각을 볼 수 있습니다.

![코드 조각 관리자](~/python/media/code-editing-code-snippets-manager.png)
...
![탐색 모음](~/python/media/code-editing-navigation-bar.png)
...
![정의로 이동](~/python/media/code-editing-go-to-definition.png)
...
![다음 탐색](~/python/media/code-editing-navigate-to.png)
...
![모든 참조 찾기 결과](~/python/media/code-editing-find-all-references.png)
