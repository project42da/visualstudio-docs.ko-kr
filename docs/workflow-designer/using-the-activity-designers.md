...
## <a name="in-this-section"></a>단원 내용  
 ...
 상호 운용 하는 데 사용 되는 활동 디자이너 [!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)] / [!INCLUDE[netfx35_short](../workflow-designer/includes/netfx35_short_md.md)] 및 [!INCLUDE[netfx40_short](../workflow-designer/includes/netfx40_short_md.md)] 워크플로 합니다.  
