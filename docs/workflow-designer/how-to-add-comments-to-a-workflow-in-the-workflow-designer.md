...
3.  항목은 주석 아이콘을 표시합니다. 주석 아이콘을 가리키면 주석 텍스트가 표시됩니다.  
     ...
     ![주석을 표시 하는 작업 시퀀스](../debugger/debug-interface-access/annotation.md "주석")  
...
3.  활동 디자이너 외부에 주석을으로 표시 하려면 활동 디자이너의 주석 영역 위로 마우스를 가져가고 하 고 클릭 하 고 **고정 해제** 아이콘  
...
3.  활동 디자이너 외부에 모든 주석의 표시 하려면 마우스 오른쪽 단추로 클릭 활동을 선택 **주석**, **모든 주석 숨기기**합니다.  
  
### <a name="editing-or-deleting-an-annotation-for-an-activity"></a>활동 주석 편집 또는 삭제  
  
1.  주석이 있는 활동을 마우스 오른쪽 단추로 클릭합니다.  
  
2.  선택 **주석**, **주석 편집** 또는 **주석 삭제**합니다.  
  
3.  편집 또는 삭제할 주석이 열립니다.  
  
4.  디자이너 및 선택 하는 워크플로 마우스 오른쪽 단추로 클릭 한 번에 모든 주석을 삭제할 **주석**, **모든 주석 삭제**합니다.  
