...
1.  현재 워크플로 프로젝트에 새 사용자 지정 활동을 추가합니다. [!INCLUDE[crabout](../test/includes/crabout_md.md)]참조 프로젝트에 새 사용자 지정 활동을 추가 [하는 방법: 워크플로 프로젝트에 새 항목 추가](../workflow-designer/how-to-add-a-new-item-to-a-workflow-project.md)합니다.  
