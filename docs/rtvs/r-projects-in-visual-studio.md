...
| 저장 프로시저 게시 | R 스크립트에 포함된 저장 프로시저를 게시하기 위한 프로세스를 시작합니다. [SQL Server 저장 프로시저 사용](integrating-sql-server-with-r.md#working-with-sql-server-stored-procedures)을 참조하세요. | 
...
| SQL 쿼리 | 빈 `.sql` 파일입니다. [SQL Server 통합](integrating-sql-server-with-r.md)을 참조하세요. |
| 저장 프로시저(R 사용) | 자식 SQL 쿼리 및 자식 저장 프로시저 템플릿 파일이 있는 R 파일입니다. [SQL Server 통합](integrating-sql-server-with-r.md)을 참조하세요. |
