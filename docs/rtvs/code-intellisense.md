...
![함수 시그니처를 표시하는 IntelliSense](~/docs/rtvs/media/intellisense-function-signature.png) 

함수나 기타 문을 입력하면 IntelliSense는 이미 입력한 내용을 기준으로 필터링된(대/소문자 구분) 자동 완성 메뉴를 제공합니다.

![IntelliSense 자동 완성 메뉴](~/docs/rtvs/media/intellisense-auto-complete-menu.png)
...
![개체 멤버에 대한 IntelliSense 제안](~/docs/rtvs/media/intellisense-auto-complete-r-objects.png)
 
ESC 키를 누르면 메뉴가 완전히 닫힙니다. Ctrl+Space를 사용하여 다시 표시할 수 있습니다.

함수 호출에 대해 여는 괄호(`(`)를 입력하면 닫는 괄호(`)`)가 삽입되고 앞에서 나온 시그니처 도움말이 표시됩니다.

![함수에 대한 IntelliSense 시그니처 도움말](~/docs/rtvs/media/intellisense-function-signature.png)
...
![사용자 정의 함수에 대한 IntelliSense](~/docs/rtvs/media/intellisense-same-file-functions.png)

![사용자 정의 함수에 대한 IntelliSense 매개 변수 완성](~/docs/rtvs/media/intellisense-parameter-completion.png)

IntelliSense는 같은 파일 및 현재 세션의 변수에도 적용됩니다.

![IntelliSense 변수 완성](~/docs/rtvs/media/intellisense-variable-completion.png)
...
![편집기의 R용 스마트 태그](~/docs/rtvs/media/intellisense-smart-tags.png)
