---
title: "테스트 탐색기를 사용하여 기존 C++ 응용 프로그램 단위 테스트 | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
-   테스트 중인 프로젝트에서 테스트할 함수를 내보내는 경우 테스트 프로젝트에서 코드 프로젝트에 대한 참조를 추가할 수 있습니다.  
    ...
    2.  솔루션 탐색기의 테스트 프로젝트 바로 가기 메뉴에서 **참조**을 선택합니다.  프로젝트 속성 창이 열립니다.  
...
1.  단위 테스트에 필요한 헤더 및 라이브러리 파일을 포함하도록 제품 코드 프로젝트 속성을 수정합니다.  
...
2.  테스트 클래스와 메서드를 단위 테스트 코드 파일에 추가합니다.  예:  
 ...
 자세한 내용은 [Unit testing native code with Test Explorer](http://msdn.microsoft.com/ko-kr/8a09d6d8-3613-49d8-9ffe-11375ac4736c)를 참조하세요.  
...
2.  테스트 탐색기에서 **모두 실행**을 선택합니다.  
 ...
 자세한 내용은 [퀵 스타트: 테스트 탐색기를 사용한 테스트 구동 방식 개발](../test/quick-start-test-driven-development-with-test-explorer.md)을 참조하세요.