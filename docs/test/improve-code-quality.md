---
title: "Visual Studio 테스트 도구 | Microsoft Docs"
ms.date: 01/31/2018
...
|[IntelliTest](../test/generate-unit-tests-for-your-code-with-intellitest.md)|IntelliTest는 단위 테스트와, 관리 코드에 대한 테스트 데이터를 자동으로 생성합니다.|
|[코드 검사](../test/using-code-coverage-to-determine-how-much-code-is-being-tested.md)|코드 검사는 프로젝트의 코드 중 유닛 테스트와 같은 코딩된 테스트를 사용하여 실제로 테스트할 부분을 결정합니다.|
|[Microsoft Fakes](../test/isolating-code-under-test-with-microsoft-fakes.md)|Microsoft Fakes는 스텁 또는 shim을 사용하는 응용 프로그램의 다른 부분을 교체함으로써 사용자가 테스트 중인 코드를 격리시켜 줍니다.|
|[유닛 테스트](../test/live-unit-testing.md)|Live Unit Testing은 자동으로 백그라운드에서 단위 테스트를 실행하고 Visual Studio 코드 편집기의 코드 검사 및 테스트 결과를 그래픽으로 표시합니다.|
|[UI 자동화](../test/use-ui-automation-to-test-your-code.md)|Coded UI 테스를 사용하여 사용자 인터페이스를 통해 응용 프로그램을 구동합니다.|
|[Lab Management](../test/lab-management/using-a-lab-environment-for-your-application-lifecycle.md)|랩 환경은 응용 프로그램을 개발하고 테스트하는 데 사용할 수 있는 가상 및 실제 컴퓨터의 컬렉션입니다.|
