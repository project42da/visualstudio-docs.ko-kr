...
부하 테스트 새로 만들기 마법사를 사용하여 부하 테스트를 만든 후에 부하 테스트 편집기를 사용하여 시나리오의 속성을 테스트 요구 사항 및 목표에 맞게 변경할 수 있습니다.
...
2.  부하 테스트 트리의 **시나리오** 폴더에서 사용할 에이전트를 지정할 시나리오 노드를 선택합니다.
...
5.  속성을 변경한 후 **파일** 메뉴에서 **저장**을 선택합니다. 그러면 새 **속도 지연에 분포 적용** 값을 사용하여 부하 테스트를 실행할 수 있습니다.
