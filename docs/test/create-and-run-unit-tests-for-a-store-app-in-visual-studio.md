...
>   
>  자세한 내용은 MSDN 라이브러리의 [코드 단위 테스트](../test/unit-test-your-code.md)을 참조하십시오.  
  
## 단원 내용  
 [C\# 코드 단위 테스트](../test/unit-testing-visual-csharp-code-in-a-store-app.md)  
  
 [C\+\+ DLL 단위 테스트](../test/unit-testing-a-visual-cpp-dll-for-store-apps.md)  
