---
title: Visual Studio에서 코딩된 UI 테스트 편집 | Microsoft Docs
ms.date: 11/04/2016
...
2012 이전 버전의 Visual Studio Enterprise를 사용하는 중일 수 있습니다. 코딩된 UI 테스트 편집기는 MSDN 구독이 포함된 Visual Studio 2010 Feature Pack 2에서도 사용할 수 있습니다. 자세한 내용은 [Microsoft Visual Studio 2010 Feature Pack 2](http://go.microsoft.com/fwlink/?LinkID=204119)를 참조합니다.
...
- 경우에 따라 테스트 중인 응용 프로그램의 UI에서 컨트롤이 위치한 지점을 시각화하기 어려울 수 있습니다. 코딩된 UI 테스트 편집기의 기능 중 하나를 사용하면, UI 컨트롤 맵에 나열된 컨트롤을 선택하고 테스트 중인 응용 프로그램에서 해당 컨트롤의 위치를 볼 수 있습니다. 자세한 내용은 이 항목 아래쪽에 있는 [테스트 중인 응용 프로그램에서 UI 컨트롤 찾기](#CodedUITestEditor_LocateUIControl)를 참조합니다.

- 편집하려는 컨트롤이 포함된 컨테이너 컨트롤을 확장해야 할 수도 있습니다. 자세한 내용은 이 항목 아래쪽에 있는 [컨토롤 및 해당 하위 요소 찾기](#CodedUITestEditor_LocateDecendants)를 참조합니다.
