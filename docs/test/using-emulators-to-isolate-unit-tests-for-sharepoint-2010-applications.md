...
-   <xref:Microsoft.VisualStudio.TestTools.UnitTesting.TestInitializeAttribute> 및 <xref:Microsoft.VisualStudio.TestTools.UnitTesting.TestCleanupAttribute> 특성을 가진 테스트 클래스 메서드는 범위를 생성 및 제거할 수 있습니다.  
