...
##  <a name="BKMK_Unit_test_frameworks_and_test_projects"></a> 단위 테스트 프레임워크 및 테스트 프로젝트  
 ...
 ![맨 위로 이동](~/docs/debugger/media/pcs_backtotop.png "PCS_BackToTop") [목차](#BKMK_Contents)  
...
###  <a name="BKMK_View_test_details"></a> 테스트 정보 보기  
 ...
 ![테스트 실행 정보](~/docs/test/media/ute_testdetails.png "UTE_TestDetails")  
...
###  <a name="BKMK_Grouping_the_test_list"></a> 테스트 목록 그룹화  
 테스트 구성 방식을 변경하려면 **그룹화 방법** 단추 ![테스트 탐색기 그룹 단추](~/docs/test/media/ute_groupby_btn.png "UTE_GroupBy_btn") 옆에 있는 아래쪽 화살표를 선택하고 새 그룹화 기준을 선택합니다.  
