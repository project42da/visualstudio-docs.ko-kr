---
title: "필드, 속성 또는 로컬-코드 생성 (C#)를 생성 | Microsoft Docs"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="generate-a-field-property-or-local-in-c"></a>C#의 필드, 속성 또는 로컬 생성 #
...
1. 다음으로, 다음 중 하나를 수행 합니다.
   * **키보드**
     * 키를 눌러 **Ctrl +.** 트리거에 **빠른 작업 및 리팩터링** 메뉴와 선택 **필드/속성/로컬 생성** 미리 보기 창 팝업에서 합니다.
   * **마우스**
     * 마우스 오른쪽 단추로 클릭 하 고 선택 된 **빠른 작업 및 리팩터링** 메뉴를 선택 **필드/속성/로컬 생성** 미리 보기 창 팝업에서 합니다.
