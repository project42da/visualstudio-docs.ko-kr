...
Dotfuscator CE를 통해 Visual Studio 사용자는 [어셈블리][obfuscation]를 난독 처리하고 [활성 방어][checks] 및 [분석 추적][analytics]을 응용 프로그램에 삽입할 수 있습니다. Dotfuscator가 없다면 모두 원래 소스 코드에 액세스해야 하는 작업입니다.
