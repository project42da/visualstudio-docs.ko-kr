...
f1_keywords: 
  - "hv_manage"
helpviewer_keywords: 
  - "콘텐츠 설치 원본 변경[도움말 뷰어 2.0]"
  - "콘텐츠 설치 원본[도움말 뷰어 2.0]"
  - "콘텐츠 다운로드[도움말 뷰어 2.0]"
  - "도움말 뷰어 2.0, 콘텐츠 설치 원본 변경"
  - "도움말 뷰어 2.0, 콘텐츠 설치 원본"
  - "도움말 뷰어 2.0, 콘텐츠 다운로드"
  - "도움말 뷰어 2.0, 로컬 콘텐츠 설치"
  - "도움말 뷰어 2.0, 로컬 콘텐츠 제거"
  - "도움말 뷰어 2.0, 로컬 콘텐츠 업데이트"
  - "로컬 콘텐츠 설치[도움말 뷰어 2.0]"
  - "로컬 콘텐츠 제거[도움말 뷰어 2.0]"
...
>  콘텐츠를 설치하려면 관리 권한이 있는 계정으로 로그온해야 합니다.  
 ...
 Visual Studio IDE가 영어 이외의 언어로 설정된 경우 영어 콘텐츠나 지역화된 콘텐츠 중 하나나 둘 모두를 설치할 수 있습니다.  그러나 영어 버전만 설치하고 **뷰어 옵션** 대화 상자에서 **Include English content in all navigation tabs and F1 requests\(모든 탐색 탭 및 F1 요청에 영어 콘텐츠 포함\)** 확인란의 선택을 취소한 경우 콘텐츠가 나타나지 않습니다.  
...
>  콘텐츠를 제거하려면 관리 권한이 있어야 합니다.  
 ...
 Visual Studio IDE가 영어 이외의 언어로 설정되어 있고 **뷰어 옵션** 대화 상자에서 **Include English content in all navigation tab and F1 requests\(모든 탐색 탭 및 F1 요청에 영어 콘텐츠 포함\)** 확인란의 선택이 취소된 경우 지역화된 콘텐츠를 제거하면 콘텐츠가 표시되지 않습니다.  
...
2.  **To\(대상\)** 텍스트 상자에 콘텐츠의 다른 위치를 입력한 다음 **확인** 단추를 선택합니다.  
