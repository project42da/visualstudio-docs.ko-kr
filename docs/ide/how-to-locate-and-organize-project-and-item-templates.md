...
ms.topic: "article"
helpviewer_keywords: 
  - "사용자 지정 템플릿 위치[Visual Studio]"
  - "항목 템플릿, 위치"
  - "프로젝트 템플릿[Visual Studio], 표시"
  - "프로젝트 템플릿[Visual Studio], 위치"
  - "템플릿[Visual Studio], 위치"
  - "Visual Studio 템플릿, 위치"
