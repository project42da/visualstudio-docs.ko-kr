...
> [!WARNING]
>  Visual Studio를 설치할 때 도움말 뷰어를 설치하는 옵션이 제공됩니다. MSDN 다운로드 사이트 대신 도움말 뷰어에서 도움말 항목을 읽기 시작하려면 도움말 뷰어를 설치한 후 Visual Studio에서 **도움말** 메뉴로 이동하고, **도움말 기본 설정 지정**을 선택한 다음, **도움말 뷰어에서 시작**을 선택합니다. 특정 버전의 Visual Studio에 대한 오프라인 도움말 항목은 해당 버전의 최종 릴리스 후에만 사용할 수 있습니다.  
