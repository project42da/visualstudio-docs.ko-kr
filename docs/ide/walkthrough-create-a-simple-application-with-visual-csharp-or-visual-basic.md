...
1. **솔루션 탐색기**에서 MainWindow.xaml을 선택합니다. **속성** 창이 표시되어야 하지만 표시되지 않는 경우 **보기** 메뉴 및 **속성 창** 항목을 선택합니다.  
...
3.  왼쪽 RadioButton 컨트롤의 **속성** 창에서 **속성** 창 맨 위에 있는 속성인 **Name** 속성을 **HelloButton**으로 변경합니다.  

     ![RadioButton 속성 창](../ide/media/exploreide-buttonproperties.png "exploreide-buttonproperties")  
  
4.  오른쪽 RadioButton 컨트롤의 **속성** 창에서 **Name** 속성을 **GoodbyeButton**으로 변경한 다음 변경 내용을 저장합니다.  
...
### <a name="to-set-a-radio-button-to-be-checked-by-default"></a>라디오 단추가 기본적으로 선택되도록 설정하려면  
...
1.  디자인 화면에서 **표시** 단추를 두 번 클릭합니다.  
     ...
     Greetings.xaml.vb 또는 Greetings.xaml.cs는 Button_Click 이벤트에 커서가 있는 상태에서 열립니다. 
...
1.  기본 메뉴에서 **빌드**를 선택하고 **솔루션 정리**를 선택하여 이전 빌드 과정에서 만들어진 중간 파일과 출력 파일을 삭제합니다. 꼭 필요한 작업은 아니지만 이 과정을 통해 디버그 빌드 출력이 정리됩니다.  
