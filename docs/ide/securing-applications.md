...
## <a name="general-security-considerations"></a>일반적인 보안 고려 사항  
 ...
 [보안 및 프로그래밍(C# 및 Visual Basic)](https://msdn.microsoft.com/library/ms233782(v=vs.100).aspx)  
...
## <a name="securing-mobile-applications"></a>모바일 응용 프로그램 보안  
 ...
 [장치 보안 고려 사항](http://msdn.microsoft.com/45fab484-8718-452e-8210-04fda3c6cb87)  
