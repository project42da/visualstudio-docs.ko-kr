...
Visual Studio IDE(통합 개발 환경)가 거의 모든 코드 언어를 사용하여 앱을 개발하는 데 어떤 도움이 되는지 알아봅니다.
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p><a href="/visualstudio/ide/reference/visual-studio-reference">Visual Studio IDE 참조</a></p>
                        <p><a href="/visualstudio/ide/reference/visual-studio-commands">Visual Studio 명령</a></p>
                        <p><a href="/visualstudio/ide/reference/devenv-command-line-switches">Devenv 명령줄 스위치</a></p>
                    </div>
                </div>
            </div>
        </div>
