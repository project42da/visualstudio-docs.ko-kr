...
### <a name="configuring-a-build"></a>빌드 구성  
 ...
 ![Visual Studio 디버그 빌드 단추](../ide/media/vs_ide_gs_debug_build_type1.PNG "Vs_ide_gs_debug_build_type1")  
 ...
 **x86**(32비트 Intel CPU), **x64**(64비트 Intel CPU) 및 **ARM**(ARM CPU, 특정 앱 형식에서만 지원됨)과 같은 특정 빌드 플랫폼을 대상으로 지정할 수도 있습니다. 관리되는 프로젝트 및 네이티브 프로젝트에 대한 기본값은 **x86**입니다. 변경하려면 빌드 플랫폼 드롭다운을 클릭하고 다른 플랫폼이나 **구성 관리자...**를 선택합니다.  
 ...
 ![Visual Studio 구성 파일 관리자 창](../ide/media/vs_ide_gs_debug_build_cf_mgr.PNG "Vs_ide_gs_debug_build_cf_mgr")  

 **구성 관리자**를 사용하여 대상 빌드 구성을 지정할 수 있습니다. 실행하고 **구성** 또는 **CPU** 드롭다운을 클릭한 다음 **새로 만들기...**를 선택하여 새 빌드 또는 플랫폼을 만듭니다.  

 ![Visual Studio 구성 관리자 창](../ide/media/vs_ide_gs_debug_build_cf_mgr_2.PNG "Vs_ide_gs_debug_build_cf_mgr_2")  
...
### <a name="debugging-your-running-code"></a>실행 중인 코드 디버그  
 ...
 ![Visual Studio 모두 중단 단추](../ide/media/vs_ide_gs_debug_break_all_button.png "vs_ide_gs_debug_break_all_button")  

 F5 키를 누르거나 **계속** 단추를 클릭하여 앱을 계속 실행합니다.  

 ![Visual Studio 디버그 계속 단추](../ide/media/vs_ide_gs_debug_continue_button.png "Vs_ide_gs_debug_continue_button")  
...
### <a name="setting-conditional-breakpoints"></a>조건부 중단점 설정  
 ...
 ![Visual Studio 조건부 중단점](../ide/media/vs_ide_gs_debug_breakpoint_conditional.PNG "Vs_ide_gs_debug_breakpoint_conditional")  
...
### <a name="inspecting-your-code-at-run-time"></a>런타임에 코드 검사  
 ...
 ![Visual Studio 진단 도구 창](../ide/media/vs_ide_gs_debug_diagnostic_tools.PNG "Vs_ide_gs_debug_diagnostic_tools")  
