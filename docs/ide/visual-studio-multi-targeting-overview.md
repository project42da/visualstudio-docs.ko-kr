...
-   [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)]의 이전 버전을 대상으로 하는 프로젝트를 열면 [!INCLUDE[vs_current_short](../code-quality/includes/vs_current_short_md.md)]에서는 프로젝트를 자동으로 업그레이드하거나 대상을 있는 그대로 유지할 수 있습니다.  
