...
1.  탐색하려는 멤버에 대한 상황에 맞는 메뉴에서 **정의 피킹**을 선택하여 정의를 피킹할 수 있습니다. Visual Studio 2017 버전 15.4 이상에서 이 옵션을 설정하는 경우 있습니다 **Ctrl** 키(또는 다른 한정자)를 누르고 멤버 이름을 클릭하여 마우스를 사용하는 정의를 피킹할 수 있습니다. 또는 키보드에서 **Alt + F12** 키를 누릅니다.  
...
2.  코드 정의 창에서 여러 위치로 커서를 이동할 수 있습니다. 원본 코드 창에서 계속 이동할 수 있습니다.  
...
2. **피킹 보기에서 정의 열기** 옵션을 선택합니다.  

3. **확인**을 클릭하여 **옵션** 대화 상자를 닫습니다.  
