...
클래스 디자이너의 클래스 다이어그램에서 기본 형식과 파생 형식 간에 상속 관계\(있는 경우\)를 찾을 수 있습니다.  두 형식 간에 상속 관계가 없는 경우 새로 만들려면 [How to: Create Inheritance Between Types \(Class Designer\)](../ide/how-to-create-inheritance-between-types-class-designer.md)를 참조하세요.  
