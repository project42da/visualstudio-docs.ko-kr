...
5.  HelloWorldVB가 폴더의 하나로 표시되어야 합니다. 폴더를 두 번 클릭합니다. 드롭다운 **HelloWorldVB**가 포함된 **코드 조각 삽입: HelloWorldVB >** 팝업이 표시되어야 합니다. HelloWorldVB 드롭다운을 클릭합니다. 파일에 추가된 다음 줄을 확인해야 합니다.  
