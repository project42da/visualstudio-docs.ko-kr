---
title: "Visual Studio의 솔루션 및 프로젝트 | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
ms.reviewer: ""
ms.suite: ""
...
helpviewer_keywords: 
  ...
  - "솔루션 탐색기에서 폴더의 솔루션 항목"
  - "솔루션 항목 공유"
  - "솔루션[Visual Studio]"
  - "프로젝트 항목에 대 한 프로젝트 항목 [Visual Studio]"
  - "작업 영역"
  - "디자인 솔루션 [Visual Studio]"
  - "프로젝트[Visual Studio]"
  - "솔루션 [Visual Studio] 프로젝트 및"
  - "vs.solutionpropertypages.projectdependencies"
  - "응용 프로그램[Visual Studio]"
  - "프로젝트 [Visual Studio] 설정"
  - "기타 파일"
...
>  원하지 않는 경우 솔루션이나 프로젝트를 사용하지 않아도 됩니다. Visual Studio에서 파일을 열고 코드 편집을 시작하면 됩니다. 자세한 내용은 [Visual Studio에서 폴더 열기](https://blogs.msdn.microsoft.com/visualstudio/2016/04/12/open-any-folder-with-visual-studio-15-preview/)를 참조하세요.
 ...
 ![Visual Studio 프로젝트 및 솔루션](../ide/media/vs2015_project_diagram.png "vs2015_project_diagram")  
