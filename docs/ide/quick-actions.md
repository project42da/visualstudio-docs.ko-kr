...
2. **Ctrl +** 줄의 임의 위치를 눌러 전구를 호출하고 잠재적 해결 방법 목록으로 바로 이동합니다.  
   ...
   ![마우스로 가리킨 전구](~/docs/ide/media/vs2015_lightbulb_hover.png "VS2017_LightBulb_Hover")  
...
![리팩터링 - 병합 충돌 해결](~/docs/ide/media/vside-refactoring-merge-conflicts.png)
...
![리팩터링 - null 검사 추가](~/docs/ide/media/vside-refactoring-nullcheck.png)
...
![리팩터링 - 생성자 생성](~/docs/ide/media/vside-refactoring-constructors.png)
...
![리팩터링 - 사용하지 않는 변수](~/docs/ide/media/vside-refactoring-unusedvars.png)
...
![리팩터링 - 재정의](~/docs/ide/media/vside-refactoring-overrides.png)

![리팩터링 - 재정의 대화 상자](~/docs/ide/media/vside-refactoring-overrides-dialog.png)
...
![리팩터링 - 기본 변경](~/docs/ide/media/vside-refactoring-changebase1.png)

![리팩터링 - 기본 변경](~/docs/ide/media/vside-refactoring-changebase2.png)
...
![리팩터링 - 자릿수 구분 기호 변경](~/docs/ide/media/vside-refactoring-separators.png)
