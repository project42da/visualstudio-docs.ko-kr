...
## <a name="intellisense-features-in-c"></a>C++의 IntelliSense 기능  
 ...
 ![도구, 옵션, 텍스트 편집기, C&#47;C&#43;&#43;, 고급](~/docs/ide/media/sintellisensecpptoolsoptions.PNG "sIntelliSenseCppToolsOptions")  
  
 다음 이미지에 표시된 메뉴 항목 및 바로 가기 키를 사용하여 IntelliSense에 액세스할 수 있습니다.  
  
 ![Visual C&#43;&#43; IntelliSense 메뉴](~/docs/ide/media/vs2015_cpp_intellisense_menu.png "vs2015_cpp_intellisense_menu")  
...
### <a name="statement-completion-and-member-list"></a>문 완성 및 멤버 목록  
 ...
 ![Visual C&#43;&#43; 단어 자동 완성 창](~/docs/ide/media/vs2015_cpp_complete_word.png "vs2015_cpp_complete_word")  
 ...
 ![Visual C&#43;&#43; 멤버 목록](~/docs/ide/media/vs2015_cpp_list_members.png "vs2015_cpp_list_members")  
...
### <a name="parameter-help"></a>매개 변수 도움말  
 ...
 ![Visual C&#43;&#43; 매개 변수 도움말](~/docs/ide/media/vs_2015_cpp_param_help.png "vs_2015_cpp_param_help")  
...
### <a name="quick-info"></a>요약 정보  
 ...
 ![Visual C&#43;&#43; 요약 정보](~/docs/ide/media/vs2015_cpp_quickinfo.png "vs2015_cpp_quickInfo")  
...
## <a name="cross-platform-intellisense"></a>플랫폼 간 IntelliSense  
 ...
 ![Android 프로젝트는 활성 프로젝트입니다.](~/docs/ide/media/intellisensecppcrossplatform.png "IntelliSenseCppCrossPlatform")  
...
-   줄 12에는 BYE 식별자에 빨간색 물결 기호가 있습니다. 이 식별자는 현재 선택한 활성 프로젝트에 정의되어 있지 않습니다.  
 ...
 ![iOS가 활성 프로젝트로 선택됩니다.](~/docs/ide/media/intellisensecppcrossplatform2.png "IntelliSenseCppCrossPlatform2")  
