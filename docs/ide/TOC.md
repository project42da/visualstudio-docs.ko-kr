...
# IDE 빠른 시작
## [먼저 Visual Studio IDE 살펴보기](quickstart-ide-orientation.md)
## [테마 및 텍스트 색 개인 설정](quickstart-personalize-the-ide.md)
## [편집기에서 코딩](quickstart-editor.md)
...
#### [코드 스타일 기본 설정](code-styles-and-quick-actions.md)
