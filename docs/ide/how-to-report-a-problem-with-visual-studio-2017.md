...
## 대체 보고<a name="alternate_reporting"></a>
 ...
 >[!Note]
 >또한 Visual Studio 개발자 커뮤니티에 직접 문제를 보고할 수도 있습니다. 이렇게 하려면 [https://developercommunity.visualstudio.com/](https://developercommunity.visualstudio.com/)을 방문하세요.

## <a name="see-also"></a>참고 항목
* [의견 보내기](../ide/talk-to-us.md)
* [Visual Studio 개발자 커뮤니티 방문](https://developercommunity.visualstudio.com/)
