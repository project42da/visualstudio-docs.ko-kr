---
title: "지역 변수 소개 - 코드 생성(Visual Basic) | Microsoft Docs"
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="introduce-a-local-variable-in-visual-basic"></a>Visual Basic에서 지역 변수 소개
...
1. 새 지역 변수에 할당할 식을 강조 표시합니다.
   ...
   ![강조 표시된 코드](media/local-highlight-vb.png)
...
1. 다음 작업 중 하나를 수행합니다.
   ...
   * **마우스**
   ...
   ![로컬 미리 보기 소개](media/local-preview-vb.png)
...
1. 지역 변수는 해당 사용에서 추론된 형식을 사용하여 자동으로 만들어집니다.  새 이름을 입력하여 새 지역 변수에 새 이름을 지정합니다.
   ...
   ![로컬 결과 소개](media/local-result-vb.png)
