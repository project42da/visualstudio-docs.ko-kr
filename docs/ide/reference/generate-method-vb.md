---
title: "메서드 생성 - 코드 생성(Visual Basic) | Microsoft Docs"
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="generate-a-method-in-visual-basic"></a>Visual Basic에서 메서드 생성
...
1. 존재하지 않는 메서드를 사용했음을 나타내는 빨간색 구부러진 곡선이 있는 줄에 커서를 놓습니다.
   ...
   ![강조 표시된 코드](media/method-highlight-vb.png)
...
1. 다음 작업 중 하나를 수행합니다.
   ...
   * **마우스**
   ...
   ![메서드 생성 미리 보기](media/method-preview-vb.png)
...
1. 메서드는 해당 사용에서 추론된 매개 변수를 사용하여 자동으로 만들어집니다.
   ...
   ![메서드 생성 결과](media/method-result-vb.png)
