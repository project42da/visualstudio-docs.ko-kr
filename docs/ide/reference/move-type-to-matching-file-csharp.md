---
title: "형식을 일치하는 파일로 이동 - 리팩터링(C#) | Microsoft Docs"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="move-a-type-to-a-matching-file-in-c"></a>C#에서 형식을 일치하는 파일로 이동 #
...
1. 이동할 형식 이름을 강조 표시하거나 형식 이름 내부에 텍스트 커서를 놓습니다.
   ...
   ![강조 표시된 코드](media/movetype-highlight-cs.png)
...
1. 다음 작업 중 하나를 수행합니다.
   ...
   * **마우스**
   ...
   ![인라인 결과](media/movetype-result-cs.png)
