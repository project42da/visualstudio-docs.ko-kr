---
title: "Visual Basic에서 메서드 시그니처 리팩터링 | Microsoft Docs"
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="change-a-method-signature-in-visual-basic"></a>Visual Basic에서 메서드 시그니처 변경
...
1. 수정할 메서드 또는 해당 사용 중 하나의 이름을 강조 표시하거나 메서드 이름 내부에 텍스트 커서를 놓습니다.
   ...
   ![강조 표시된 코드](media/changesignature-highlight-vb.png)
...
1. 표시되는 **시그니처 변경** 대화 상자에서 오른쪽 단추를 사용하여 메서드 시그니처를 변경할 수 있습니다.
   ...
   ![시그니처 변경 대화 상자](media/changesignature-dialog-vb.png)
...
1. 완료되면 **확인** 단추를 눌러 변경합니다.
   ...
   ![시그니처 변경 결과](media/changesignature-result-vb.png)
