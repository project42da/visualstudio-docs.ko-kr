---
title: "Visual Studio에서 C# 형식과 일치하도록 파일 이름 바꾸기 | Microsoft Docs"
ms.custom: 
ms.date: 02/27/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="sync-a-type-to-a-filename-or-a-filename-to-a-type-in-c"></a>C#에서 형식을 파일 이름으로 또는 파일 이름을 형식으로 동기화 #
...
1. 동기화할 형식 이름을 강조 표시하거나 형식 이름 내부에 텍스트 커서를 놓습니다.
   ...
   ![강조 표시된 코드](media/synctype-highlight-cs.png)
...
1. 다음 작업 중 하나를 수행합니다.
   ...
   * **마우스**
   ...
   형식 또는 파일의 이름이 즉시 바뀝니다.  아래 예제에서는 **MyClass.cs** 파일의 이름이 형식 이름과 일치하도록 **MyNewClass.cs**로 바뀌었습니다.

   ![인라인 결과](media/synctype-result-cs.png)
