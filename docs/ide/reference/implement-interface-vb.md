---
title: "인터페이스 구현 - 코드 생성(Visual Basic) | Microsoft Docs"
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="implement-an-interface-in-visual-basic"></a>Visual Basic에서 인터페이스 구현
...
1. 인터페이스를 참조했지만 모든 필요한 멤버를 구현하지 않았음을 나타내는 빨간색 구부러진 곡선이 있는 줄에 커서를 놓습니다.
   ...
   ![강조 표시된 코드](media/interface-highlight-vb.png)
...
1. 다음 작업 중 하나를 수행합니다.
   ...
   * **마우스**
   ...
   ![클래스 구현 미리 보기](media/interface-preview-vb.png)
...
1. 인터페이스의 메서드 시그니처가 자동으로 만들어지고 구현할 준비가 됩니다.
   ...
   ![클래스 구현 결과](media/interface-result-vb.png)
