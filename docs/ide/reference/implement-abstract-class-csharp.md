---
title: "추상 클래스 구현 - 코드 생성(C#) | Microsoft Docs"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="implement-an-abstract-class-in-c"></a>C#에서 추상 클래스 구현 #
...
1. 추상 클래스에서 상속되었지만 모든 필요한 멤버를 구현하지 않았음을 나타내는 빨간색 구부러진 곡선이 있는 줄에 커서를 놓습니다.
   ...
   ![강조 표시된 코드](media/abstract-highlight-cs.png)
...
1. 추상 메서드 시그니처가 자동으로 만들어지고 구현할 준비가 됩니다.
   ...
   ![클래스 구현 결과](media/abstract-result-cs.png)
