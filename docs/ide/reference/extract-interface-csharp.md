---
title: "C#에서 인터페이스 추출 | Microsoft Docs"
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="extract-an-interface-in-c"></a>C#에서 인터페이스 추출 #
...
1. 작업을 수행할 클래스의 이름을 강조 표시하거나 클래스 이름 내부에 텍스트 커서를 놓습니다.
   ...
   ![강조 표시된 코드](media/extractinterface-highlight-cs.png)
...
1. 표시되는 **인터페이스 추출** 대화 상자에서 요청된 정보를 입력합니다. ![인터페이스 추출](media/extractinterface-dialog-cs.png)
   | 필드 | 설명 |
   | --- | --- |
...
1. **확인**을 클릭합니다.
   ...
   ![결과 클래스](media/extractinterface-class-cs.png)
   ![결과 인터페이스](media/extractinterface-interface-cs.png)
