---
title: "Visual Basic에서 인터페이스 추출 | Microsoft Docs"
ms.custom: 
ms.date: 11/17/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="extract-an-interface-in-visual-basic"></a>Visual Basic에서 인터페이스 추출
...
1. 작업을 수행할 클래스의 이름을 강조 표시하거나 클래스 이름 내부에 텍스트 커서를 놓습니다.
   ...
   ![강조 표시된 코드](media/extractinterface-highlight-vb.png)
...
1. 표시되는 **인터페이스 추출** 대화 상자에서 요청된 정보를 입력합니다. ![인터페이스 추출](media/extractinterface-dialog-vb.png)
   | 필드 | 설명 |
   | --- | --- |
...
1. **확인**을 클릭합니다.
   ...
   지정된 이름의 파일에 인터페이스가 즉시 만들어집니다.  또한 선택한 클래스가 이제 해당 인터페이스를 구현합니다.

   ![결과 클래스](media/extractinterface-class-vb.png)
   ![결과 인터페이스](media/extractinterface-interface-vb.png)
