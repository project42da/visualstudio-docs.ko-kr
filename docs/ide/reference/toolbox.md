...
**도구 상자**는 컨트롤 및 [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] 프로젝트에 추가할 수 있는 기타 항목의 아이콘을 표시합니다.  **도구 상자**를 열려면 **보기** 메뉴에서 **도구 상자**를 클릭합니다.  **도구 상자**를 도킹하고 열린 상태로 고정하거나 **자동 숨기기**로 설정할 수 있습니다.  
