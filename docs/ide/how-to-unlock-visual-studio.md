...
최대 30일 동안 무료로 Visual Studio 평가판을 사용할 수 있습니다. IDE에 로그인하면 평가판 사용 기간이 90일로 연장됩니다. Visual Studio를 계속 사용하려면 다음과 같은 방법으로 IDE를 잠금 해제할 수 있습니다.  
  
1.  온라인 구독 사용  
1.  제품 키 입력  
  
온라인 구독을 사용하여 Visual Studio의 잠금을 해제하려면  
...
1.  Microsoft 계정이나 회사 또는 학교 계정에 대한 자격 증명을 입력합니다. Visual Studio에서 해당 계정과 연결된 MSDN 구독 또는 Visual Studio Team Services 구독을 찾습니다.  
...
1.  Visual Studio를 사용한 적이 없거나 오랫동안 인터넷에 연결하지 않았습니다.   
1.  Visual Studio에서 로그아웃했습니다.  
...
1.  구독을 갱신합니다. 사용 중인 라이선스에 대한 자세한 정보를 보려면 **파일 > 계정 설정**으로 이동하고 대화 상자의 오른쪽에 있는 라이선스 정보를 살펴봅니다.  
  
1.  다른 계정에 연결된 다른 구독이 있는 경우 **계정 추가** 링크를 선택하여 **파일 > 계정 설정** 대화 상자의 왼쪽에 있는 **모든 계정** 목록에 해당 계정을 추가합니다.  
