...
|**형식 멤버 만들기 및 수정**: 클래스 세부 내용 창을 사용하여 새 멤버를 만들고 멤버를 수정하고 메서드에 매개 변수를 추가할 수 있습니다.|-   [멤버 만들기](creating-and-configuring-type-members.md#CreateMembers)<br />-   [형식 멤버 수정](creating-and-configuring-type-members.md#ModifyTypeMembers)<br />-   [메서드에 매개 변수 추가](creating-and-configuring-type-members.md#AddMethodParams)|
