...
-   [클래스 다이어그램 확대/축소](how-to-customize-class-diagrams.md#ZoomInOut)  
  
-   [형식 멤버의 그룹화 및 정렬 사용자 지정](how-to-customize-class-diagrams.md#CustomizeGroupingSorting)  
  
-   [형식의 구획 숨기기](how-to-customize-class-diagrams.md#HideCompartments)  
  
-   [형식의 개별 멤버 숨기기](how-to-customize-class-diagrams.md#HideMembers)  
  
-   [형식의 숨겨진 구획 및 멤버 표시](how-to-customize-class-diagrams.md#DisplayHiddenCompartmentsAndMemberrs)  
  
-   [관계 숨기기](how-to-customize-class-diagrams.md#HideAssociationAndInheritance)  
  
-   [숨겨진 관계 표시](how-to-customize-class-diagrams.md#DisplayAssociationAndInheritance)  
  
-   [클래스 다이어그램에서 도형 제거](how-to-customize-class-diagrams.md#RemoveCodeAndShape)  
  
-   [형식 도형 및 해당 내부 코드 삭제](how-to-customize-class-diagrams.md#DeleteTypeShapeAndCode)  
