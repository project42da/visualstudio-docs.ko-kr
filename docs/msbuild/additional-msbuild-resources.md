...
문제 해결 시 설명서에서 필요한 정보를 찾을 수 없는 경우 기술 자료 문서, 개발자 커뮤니티 또는 제품 지원과 같은 기타 리소스를 참조할 수 있습니다.  
  
## 기술 자료 문서  
 온라인으로 제품 문제와 관련한 KB\(기술 자료\) 문서를 검색할 수 있습니다.  모든 문제에 대해 해당하는 기술 자료 문서가 있는 것은 아니지만 상당수의 고객이 경험하는 오류는 대개 문서화되어 있습니다.   [기술 \(MSBuild 검색 결과\)](http://search.microsoft.com/supportresults.aspx?q=knowledge+base+MSBuild&x=0&y=0) 웹 사이트에서 기술 자료 문서에 액세스할 수 있습니다.  
  
## 커뮤니티 포럼  
 포럼을 통해 Microsoft 직원은 물론 다른 개발자와도 의견을 교환할 수 있습니다.  해결 방법을 찾을 수 없는 오류가 발생하면 해당 문제에 대한 질문을 포럼에 게시할 수 있습니다.  또한 뉴스 그룹을 검색하여 다른 개발자가 동일한 문제에 대한 내용을 게시했는지 확인할 수 있습니다.  [MSDN 포럼](http://go.microsoft.com/fwlink/?LinkId=48931) 웹 사이트에서 Visual Studio MSBuild 포럼에 액세스할 수 있습니다.  
  
 [채널 9 MSBuild](http://channel9.msdn.com/) 웹 사이트에서 [!INCLUDE[vstecmsbuild](../extensibility/internals/includes/vstecmsbuild_md.md)] 커뮤니티 리소스에 액세스할 수 있습니다.  
  
## 기술 지원  
 다른 리소스를 확인한 후에도 질문 사항이 있는 경우 [Microsoft 고객지원](http://go.microsoft.com/fwlink/?linkid=1782) 웹 사이트를 방문하여 Microsoft 지원 서비스에 문의할 수 있습니다.  해당 지역에서 사용 가능한 기술 지원에 대한 자세한 내용은 [의견 보내기](../ide/talk-to-us.md)를 참조하십시오.  
