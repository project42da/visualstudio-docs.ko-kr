---
title: "이미지 셰이프의 속성 | Microsoft Docs"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|사용자 지정 특성|이 셰이프에서 생성 되는 소스 코드 클래스에 특성을 추가 하는 데 사용 합니다.|\<none>|  
