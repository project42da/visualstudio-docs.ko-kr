---
title: "응용 프로그램에 대 한 모델을 만들기 | Microsoft 문서"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
모델링 다이어그램을 통해 코드에 대한 아이디어 및 소프트웨어 시스템에서 지원해야 하는 사용자 요구 사항을 이해하고 분명히 설명하고 전달할 수 있습니다.
 ...
 각 다이어그램 형식의 지 원하는 Visual Studio의 버전을 확인 하려면 참조 [아키텍처 및 모델링 도구에 대 한 버전 지원](../modeling/what-s-new-for-design-in-visual-studio.md#VersionSupport)합니다.  
...
|**항목**|**Task**|  
|---------------|--------------|  
|[코드 시각화](../modeling/visualize-code.md)|코드 맵을 만들고 종속성 다이어그램을 더 나은 익숙하지 않은 코드를 이해 합니다.|  
