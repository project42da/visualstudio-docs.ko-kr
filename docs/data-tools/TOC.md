...
# 자습서
## [ADO.NET을 사용하여 간단한 데이터 앱 만들기](create-a-simple-data-application-by-using-adonet.md)
## [WPF 및 Entity Framework를 사용하여 간단한 데이터 앱 만들기](create-a-simple-data-application-with-wpf-and-entity-framework-6.md)
## [C++ 앱에서 데이터에 연결](visual-studio-data-tools-for-cpp.md)
## [O/R 디자이너를 사용하여 LINQ to SQL 클래스 만들기](walkthrough-creating-linq-to-sql-classes-by-using-single-table-inheritance-o-r-designer.md)
## [N 계층 데이터 응용 프로그램 만들기](walkthrough-creating-an-n-tier-data-application.md)
# 개념
## [호환되는 데이터베이스 시스템](installing-database-systems-tools-and-samples.md)
## [.NET용 Visual Studio 데이터 도구](visual-studio-data-tools-for-dotnet.md)
## [Entity Framework 도구](entity-data-model-tools-in-visual-studio.md)
## [데이터 집합 도구](dataset-tools-in-visual-studio.md)
### [형식화된 데이터 집합 및 형식화되지 않은 데이터 집합](typed-vs-untyped-datasets.md)
### [TableAdapters 개요](fill-datasets-by-using-tableadapters.md)
### [n 계층 응용 프로그램에서 데이터 집합 작업](work-with-datasets-in-n-tier-applications.md)
## [데이터베이스 프로젝트 및 데이터 계층 응용 프로그램(DAC)](creating-and-managing-databases-and-data-tier-applications-in-visual-studio.md)
## [N 계층 데이터 응용 프로그램 개요](n-tier-data-applications-overview.md)
# 방법 가이드
## [데이터베이스 만들기](create-a-sql-database-by-using-a-designer.md)
## [연결 추가](add-new-connections.md)
### [연결 문자열 저장 및 편집](how-to-save-and-edit-connection-strings.md)
### [Access 데이터베이스의 데이터에 연결](connect-to-data-in-an-access-database-windows-forms.md)
## [.NET 데이터 원본 추가](add-new-data-sources.md)
## [LINQ to SQL 도구 사용](linq-to-sql-tools-in-visual-studio2.md)
### [DataContext 메서드의 반환 형식 변경](how-to-change-the-return-type-of-a-datacontext-method-o-r-designer.md)
### [저장 프로시저에 매핑된 DataContext 메서드 만들기](how-to-create-datacontext-methods-mapped-to-stored-procedures-and-functions-o-r-designer.md)
### [O/R 디자이너를 사용하여 상속 구성](how-to-configure-inheritance-by-using-the-o-r-designer.md)
### [테이블 및 뷰에 매핑된 LINQ to SQL 클래스 만들기](how-to-create-linq-to-sql-classes-mapped-to-tables-and-views-o-r-designer.md)
### [O/R 디자이너에서 생성한 코드 확장](how-to-extend-code-generated-by-the-o-r-designer.md)
### [LINQ to SQL 클래스 간 연결 만들 기](how-to-create-an-association-relationship-between-linq-to-sql-classes-o-r-designer.md)
### [엔터티 클래스에 유효성 검사 추가](how-to-add-validation-to-entity-classes.md)
### [엔터티 클래스의 삽입, 업데이트 및 삭제 동작 사용자 지정](walkthrough-customizing-the-insert-update-and-delete-behavior-of-entity-classes.md)
### [저장 프로시저를 할당하여 업데이트, 삽입 및 삭제 수행](how-to-assign-stored-procedures-to-perform-updates-inserts-and-deletes-o-r-designer.md)
### [복수 적용 설정 및 해제](how-to-turn-pluralization-on-and-off-o-r-designer.md)
## 데이터 집합 도구 사용
### [Visual Studio에서 데이터 집합 만들기 및 구성](create-and-configure-datasets-in-visual-studio.md)
#### [데이터 집합 간 관계 만들기](relationships-in-datasets.md)
#### [데이터 집합 디자이너를 사용하여 데이터 집합 만들기](walkthrough-creating-a-dataset-with-the-dataset-designer.md)
#### [데이터 집합 디자이너를 사용하여 DataTable 만들기](walkthrough-creating-a-datatable-in-the-dataset-designer.md)
### TableAdapter
...
## [데이터 소스에 컨트롤 바인딩](bind-controls-to-data-in-visual-studio.md)
...
### [데이터에 WPF 컨트롤 바인딩](bind-wpf-controls-to-data-in-visual-studio.md)
...
#### [조회 테이블 만들기](create-lookup-tables-in-wpf-applications.md)
#### [관련 데이터 표시](display-related-data-in-wpf-applications.md)
#### [데이터베이스의 그림에 컨트롤 바인딩](bind-controls-to-pictures-from-a-database.md)
### [데이터에 Windows Forms컨트롤 바인딩](bind-windows-forms-controls-to-data-in-visual-studio.md)
...
#### [조회 테이블 만들기](create-lookup-tables-in-windows-forms-applications.md)
#### [데이터 검색을 위한 Windows Form 만들기](create-a-windows-form-to-search-data.md)
#### [단순 데이터 바인딩을 지원하는 사용자 정의 컨트롤 만들기](create-a-windows-forms-user-control-that-supports-simple-data-binding.md)
#### [복합 데이터 바인딩을 지원하는 사용자 정의 컨트롤 만들기](create-a-windows-forms-user-control-that-supports-complex-data-binding.md)
#### [조회 데이터 바인딩을 지원하는 사용자 정의 컨트롤 만들기](create-a-windows-forms-user-control-that-supports-lookup-data-binding.md)
#### [폼 간에 데이터 전달](pass-data-between-forms.md)
### [사용자 지정 개체 바인딩](bind-objects-in-visual-studio.md)
...
## [Windows Communication Foundation 서비스 및 WCF Data Services](windows-communication-foundation-services-and-wcf-data-services-in-visual-studio.md)
### [개념적 모델 작업](working-with-a-conceptual-model-wcf-data-services.md)
### [서비스의 데이터에 연결](how-to-connect-to-data-in-a-service.md)
### [Windows Forms에서 WCF 서비스 만들기](walkthrough-creating-a-simple-wcf-service-in-windows-forms.md)
### [WPF 및 Entity Framework를 사용하여 WCF 데이터 서비스 만들기](walkthrough-creating-a-wcf-data-service-with-wpf-and-entity-framework.md)
### [서비스 참조 문제 해결](troubleshooting-service-references.md)
### [서비스 참조 구성 대화 상자](configure-service-reference-dialog-box.md)
### [WCF 데이터 서비스 참조 추가, 업데이트 또는 제거](how-to-add-update-or-remove-a-wcf-data-service-reference.md)
## [.mdf 파일 업그레이드](upgrade-dot-mdf-files.md)
## [데이터 액세스 오류 문제 해결](additional-resources-for-troubleshooting-data-access-errors.md)
# 참조
## O/R 디자이너(Linq to SQL)
### [DataContext 메서드](datacontext-methods-o-r-designer.md)
### [데이터 클래스 상속](data-class-inheritance-o-r-designer.md)
