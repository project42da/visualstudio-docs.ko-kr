...
### [방법: 복수형 설정 및 해제(OR 디자이너)](how-to-turn-pluralization-on-and-off-o-r-designer.md)
...
### [연습: Windows Forms에서 WCF 서비스 만들기](walkthrough-creating-a-simple-wcf-service-in-windows-forms.md)
