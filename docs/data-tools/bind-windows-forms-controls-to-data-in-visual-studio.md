...
![BindingNavigator이 있는 GridView](../data-tools/media/raddata-gridview-with-bindingnavigator.png)

각각의 오른쪽 위 모서리에 있는 스마트 태그를 클릭 하 여 DataGridView 및 BindingNavigator의 동작을 사용자 지정할 수 있습니다.

![DataGridView 및 탐색기 바인딩 스마트 태그](../data-tools/media/raddata-datagridview-and-binding-navigator-smart-tags.png)
