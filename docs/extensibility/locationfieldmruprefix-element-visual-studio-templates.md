...
helpviewer_keywords: 
  - "<LocationFieldMRUPrefix> 요소[Visual Studio 템플릿]"
  - "LocationFieldMRUPrefix 요소[Visual Studio 템플릿]"
...
**새 프로젝트** 및 **새 항목 추가** 대화 상자에 MRU\(가장 최근에 사용한\) 경로를 지정합니다.  
...
## 설명  
 이 요소는 [!INCLUDE[vsipprvsip](../extensibility/includes/vsipprvsip_md.md)]을 통해 생성되는 템플릿에만 사용해야 합니다.  
