...
![VSSDK 빌드 도구](~/extensibility/media/vssdk-build-tools.png)
...
* 선택 **필수 구성 요소** 탭 및 키를 눌러 **새로** 단추입니다.
  ...
  ![VSIX 매니페스트 디자이너](~/extensibility/media/vsix-manifest-designer.png)

* **추가 새 필수 구성 요소** 창이 열립니다.

  ![vsix 필수 구성 요소를 추가 합니다.](~/extensibility/media/add-vsix-prerequisite.png)
...
* 필요한 경우에 버전을 업데이트 합니다.
  ...
  ![roslyn 필수 구성 요소를 추가 합니다.](~/extensibility/media/add-roslyn-prerequisite.png)
...
![시작 외부 프로그램](~/extensibility/media/start-external-program.png)
...
![Visual Studio 2017에서 VSIX 설치 관리자](~/extensibility/media/vsixinstaller-vs-2017.png)
...
![프로세스를 실행 하는 vs](~/extensibility/media/vs-running-processes.png)
...
![vsixinstaller 누락 된 필수 구성 요소](~/extensibility/media/vsixinstaller-missing-prerequisite.png)
