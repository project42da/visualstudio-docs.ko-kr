...
## 확장 및 Visual Studio에서 업데이트에 개인 갤러리를 추가합니다.  
 ...
 ![확장 관리자 추가 대화 상자](~/docs/extensibility/media/em_adddialog.png "EM\_AddDialog")  
...
## 개인 갤러리에서 확장을 설치합니다.  
 ...
 ![전용 갤러리를 설치하는 확장 관리자](~/docs/extensibility/media/em_.png "EM\_")  
...
## 개인 갤러리에서 확장을 업데이트합니다.  
 ...
 ![확장 관리자 전용 갤러리 업데이트](~/docs/extensibility/media/em_update.png "EM\_Update")  
