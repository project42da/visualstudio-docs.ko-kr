...
다음은 열거형에는 [!INCLUDE[vsprvs](../../../code-quality/includes/vsprvs_md.md)] SDK 디버깅 합니다.  
 ...
 중단점을 설정할 때 추가 정보를 지정 하는 데 사용할 수 있는 선택적 플래그에 대 한 유효한 값을 열거 합니다.  이 열거형에 확장 되는 [BP\_FLAGS](../../../extensibility/debugger/reference/bp-flags.md) 열거형입니다.  
 ...
 중단점이 발생 하도록 발생 합니다 중단점 통과 횟수와 관련 된 조건을 지정 합니다.  
 ...
 어떤 정보가 성공적으로 해상도를 중단점에 대 한 검색할 수를 지정 합니다.  
 ...
 디버그 패키지 디버그 서버 사이의 통신에 사용 되는 프로토콜을 나타내는 값입니다.  
 ...
 다양 한 특성에 설명 된 [IDebugProperty2](../../../extensibility/debugger/reference/idebugproperty2.md) 또는 [IDebugReference2](../../../extensibility/debugger/reference/idebugreference2.md) 인터페이스입니다.  
 ...
 사용 하는 정보 종류를 나타내는 유효한 값을 열거에 [IDebugField](../../../extensibility/debugger/reference/idebugfield.md) 개체 및 사용자에 게 표시 합니다.  
 ...
 다른 종류의 필드에 열거 된 [IDebugField](../../../extensibility/debugger/reference/idebugfield.md) 개체가 포함 될 수 있습니다.  이 열거형에 확장 되는 [FIELD\_KIND](../../../extensibility/debugger/reference/field-kind.md) 열거형입니다.  
