...
-   특정 창 기본 표시 항목 및 범주를 사용 하 여 사용 하도록 IDE에 알립니다는 `T:Microsoft.VisualStudio.TextManager.Interop.IVsTextEditorPropertyCategoryContainer` 및 `T:Microsoft.VisualStudio.TextManager.Interop.IVsTextEditorPropertyContainer` 인터페이스입니다.  
