...
|양호|잘못 되었습니다.|  
|--------|---------------|  
|"는 번호로 전화를 걸는 서비스에서 더 이상. 번호를 확인 하 고 다시 전화 하거나 하십시오 연산자에 대 한 0 다이얼. "|-   "\(449\) 오류: 잘못 된 수"<br />-   "이 처리 되지 않은 예외 오류가 나타냅니다 작업이 성공적으로 완료 되었음을."<br /><br /> ![Bad error message in Visual Studio](~/docs/extensibility/ux-guidelines/media/0602-a_errordialog.png "0602\-a\_ErrorDialog")|  
