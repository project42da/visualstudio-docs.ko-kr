...
2.  새 VSIX 프로젝트에 추가 (**파일 / 새로 만들기 / 프로젝트 / Visual C# / 확장성 / VSIX 프로젝트**) 프로젝트 템플릿 프로젝트와 동일한 솔루션에 (에 **솔루션 탐색기**, 솔루션 노드를 선택 마우스 오른쪽 단추로 클릭 하 고 선택 **추가 / 새 프로젝트**). 이름을 **MyProjectWizard 합니다.**  
