...
|CommandLineLogo|string|콘솔 창에는 응용 프로그램이 실행 될 때 배너 텍스트입니다. 이 설정은 명령줄 빌드 작업을 지 원하는 응용 프로그램만 적용 됩니다.<br /><br /> 기본값은 "*companyName**solutionName* 버전 1.0입니다.", 여기서 *companyName* 및Windows를설치할때제공되는회사의이름인*solutionName* 응용 프로그램 솔루션 파일의 이름입니다.|  
...
|HideSolutionConcept|dword|모든 프로젝트 독립적으로 프로젝트를 만들고 기본적으로 솔루션 및 프로젝트의 독립 실행형 솔루션 관련 명령을 숨기 true 그렇지 않으면 false입니다.<br /><br /> 경우는 **솔루션 항상 표시** 옵션은 응용 프로그램에서 사용할 수 있는 다음이 설정은 옵션의 기본 상태에도 영향을 줍니다. 자세한 내용은 참조 [NIB: 일반, 프로젝트 및 솔루션, 옵션 대화 상자](http://msdn.microsoft.com/en-us/8f8e37e8-b28d-4b13-bfeb-ea4d3312aeca)합니다.<br /><br /> 기본값은 false입니다.|  
...
-   Common7\IDE\\\PublicAssemblies  
 ...
 바인딩 경로에 디렉터리를 추가 하려면 폼의 항목을 추가 "*디렉터리 이름*"="", 여기서 *디렉터리 이름* 는 절대 경로입니다. 예를 들면 다음과 같습니다.  
