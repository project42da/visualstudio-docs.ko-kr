...
## <a name="getting-started"></a>시작  
 [Roslyn 라이브 코드 분석기 및 해결 방법 소개](https://msdn.microsoft.com/en-us/magazine/dn879356.aspx)  
  
 [분석기 문제에 대 한 사용자가 수정 제공 코드 해결 연습 adding:](https://msdn.microsoft.com/en-us/magazine/dn904670.aspx)  
