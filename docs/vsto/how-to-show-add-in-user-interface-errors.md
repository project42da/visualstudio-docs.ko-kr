...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "추가 기능[Visual Studio에서 Office 개발], 사용자 인터페이스 오류"
  - "오류[Visual Studio에서 Office 개발], 사용자 인터페이스 오류"
  - "사용자 인터페이스[Visual Studio에서 Office 개발], 오류"
  - "응용 프로그램 수준 추가 기능[Visual Studio에서 Office 개발], 사용자 인터페이스 오류"
...
### VSTO 추가 기능 사용자 인터페이스 오류를 표시하려면  
