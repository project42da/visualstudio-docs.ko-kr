...
# 방법: Word 문서에 XMLNode 컨트롤 추가
 ...
 반복되지 않는 XML 스키마 요소를 Microsoft Office Word 문서에 매핑할 때 Visual Studio에서는 <xref:Microsoft.Office.Tools.Word.XMLNode> 컨트롤을 문서에 자동으로 추가합니다.  반복되는 XML 스키마 요소 매핑에 대한 자세한 내용은 [방법: Word 문서에 XMLNodes 컨트롤 추가](../vsto/how-to-add-xmlnodes-controls-to-word-documents.md)를 참조하십시오.  
  
> [!NOTE]  
>  <xref:Microsoft.Office.Tools.Word.XMLNode> 컨트롤은 **도구 상자**나 **데이터 소스** 창에서 사용할 수 없고 프로그래밍 방식으로 만들 수도 없습니다.  
  
 [!INCLUDE[note_settings_general](../sharepoint/includes/note-settings-general-md.md)]  
  
### 문서에 XMLNode 컨트롤을 추가하려면  
...
5.  반복되지 않는 스키마 요소가 들어 있는 XML 스키마를 **스키마 추가** 대화 상자에서 선택하고 **열기**를 클릭합니다.  
...
9. **XML 구조** 작업 창에서 반복되지 않는 스키마 요소를 클릭하여 문서에 추가합니다.  
  
     <xref:Microsoft.Office.Tools.Word.XMLNode> 컨트롤이 작성되고 프로젝트에 추가됩니다.  
