---
title: "Visual Studio의 Office 솔루션 아키텍처 | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Visual Studio에서 Office 개발, 아키텍처"
  - "아키텍처[Visual Studio에서 Office 개발], 솔루션"
  - "Office 응용 프로그램[Visual Studio에서 Office 개발], 아키텍처"
...
## 단원 내용  
 ...
 최종 사용자 컴퓨터에서 VSTO 추가 기능을 검색하고 로드하는 데 필요한 레지스트리 키에 대해 설명합니다.  
