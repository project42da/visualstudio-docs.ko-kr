...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "응용 프로그램 배포[Visual Studio에서 Office 개발]"
  - "게시, Office 솔루션"
  - "속성 페이지 대화 상자, 게시[Visual Studio에서 Office 개발]"
...
---
# 게시 페이지, 프로젝트 디자이너(Visual Studio에서는 Office 개발)
...
> [!NOTE]  
>  게시 위치를 **게시 마법사**에서 설정할 수도 있습니다. 자세한 내용은 [방법: ClickOnce를 사용하여 Office 솔루션 게시](http://msdn.microsoft.com/ko-kr/2b6c247e-bc04-4ce4-bb64-c4e79bb3d5b8)을 참조하세요.  
 ...
 **폴더 위치 게시\(웹 사이트, ftp 서버 또는 파일 경로\)**  
 ...
 옵션에는 로컬 컴퓨터, UNC 파일 공유 또는 HTTP\/HTTPS 웹 사이트가 포함됩니다. 로컬 경로\(*c:\\foldername\\publishfolder*\), 상대 경로\(*publish\\*\) 또는 정규화된 위치\(*\\\\servername\\foldername* 또는 http:\/\/*servername\/foldername*\)를 지정할 수 있습니다.  
 ...
 **설치 폴더 URL**  
 ...
 옵션에는 로컬 컴퓨터, UNC 파일 공유 또는 HTTP\/HTTPS 웹 사이트가 포함됩니다. 로컬 경로\(*c:\\foldername\\publishfolder*\), 상대 경로\(*publish\\*\) 또는 정규화된 위치\(*\\\\servername\\foldername* 또는 http:\/\/*servername\/foldername*\)를 지정할 수 있습니다. 모든 HTTP\/HTTPS 위치는 US ASCII 문자로 만들어야 합니다. 유니코드 문자는 지원되지 않습니다.  
 ...
 이 값은 관리자가 나중에 할당할 수 있습니다. 자세한 내용은 [Office 솔루션의 설치 경로 변경 방법](http://msdn.microsoft.com/ko-kr/d0eaa07b-2d72-4902-899f-2f9fb165b8fd)을 참조하세요.  
...
## 참고 항목  
 ...
 [배포를 위한 Office 솔루션 필수 조건](http://msdn.microsoft.com/ko-kr/9f672809-43a3-40a1-9057-397ce3b5126e)  
