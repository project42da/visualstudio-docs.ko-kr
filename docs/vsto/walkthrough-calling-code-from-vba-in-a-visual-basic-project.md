...
-   VBA에서 Visual C# 사용자 지정의 코드를 호출합니다. 이 프로세스는 Visual Basic 프로세스와 다릅니다. 자세한 내용은 참조 [연습: VBA에서 Visual C# 35;에서 코드 호출 프로젝트](../vsto/walkthrough-calling-code-from-vba-in-a-visual-csharp-project.md)합니다.  
