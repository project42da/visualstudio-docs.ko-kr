---
title: "포함 목록을 사용 하 여 Office 솔루션 신뢰 | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
## <a name="clickonce-trust-prompt"></a>ClickOnce 신뢰 프롬프트  
 ...
 자세한 내용은 [How to: Configure Inclusion List Security](../vsto/how-to-configure-inclusion-list-security.md) 및 [ClickOnce 신뢰할 수 있는 게시자 구성](http://go.microsoft.com/fwlink/?LinkId=94774)의 표 2 PromptingLevel 레지스트리 키 값 시작 효과를 참조하세요.  
