---
title: "Outlook 솔루션 | Microsoft Docs"
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
## <a name="creating-an-outlook-vsto-add-in-project"></a>Outlook VSTO 추가 기능 프로젝트 만들기  
...
## <a name="automating-outlook-by-using-the-outlook-object-model"></a>Outlook 개체 모델을 사용하여 Outlook 자동화  
...
-   Outlook 폴더에서 항목을 검색합니다.  
 ...
 자세한 내용은 [Outlook Object Model Overview](../vsto/outlook-object-model-overview.md)을 참조하십시오.  
  
## <a name="customizing-the-user-interface-of-an-outlook-application"></a>Outlook 응용 프로그램의 사용자 인터페이스 사용자 지정  
...
|제목|설명|  
|-----------|-----------------|  
|[Outlook Object Model Overview](../vsto/outlook-object-model-overview.md)|Outlook 개체 모델에서 제공하는 개체에 대해 설명합니다.|  
