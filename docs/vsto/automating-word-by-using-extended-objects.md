...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Word[Visual Studio에서 Office 개발], 자동화"
  - "확장된 개체[Visual Studio에서 Office 개발], Word"
  - "자동화[Visual Studio에서 Office 개발], Word"
  - "호스트 항목[Visual Studio에서 Office 개발], Word"
  - "Word 자동화"
  - "컨트롤[Visual Studio에서 Office 개발], Word 호스트 컨트롤"
  - "호스트 컨트롤, Word"
  - "호스트 컨트롤[Visual Studio에서 Office 개발], Word"
...
## 문서 호스트 항목  
 ...
 자세한 내용은 [문서 호스트 항목](../vsto/document-host-item.md)을 참조하십시오.  
