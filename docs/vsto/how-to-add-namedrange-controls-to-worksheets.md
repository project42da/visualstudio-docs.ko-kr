...
2.  **데이터 원본** 창에서 워크시트로 단일 필드를 끌어 놓습니다.  
     ...
     데이터 바인딩된 <xref:Microsoft.Office.Tools.Excel.NamedRange> 컨트롤이 워크시트에 추가됩니다. 자세한 내용은 [데이터 바인딩 및 Windows Forms](../Topic/Data%20Binding%20and%20Windows%20Forms.md)을 참조하세요.  
