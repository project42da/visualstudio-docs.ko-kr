---
title: "자동 저장 Office 솔루션에 미치는 영향에 | Microsoft Docs"
ms.custom: 
ms.date: 07/20/2017
ms.reviewer: 
ms.suite: 
...
참고: Windows 데스크톱 Word, Excel 및 PowerPoint에 대 한 자동 저장 2017에서 도입 되었으며 현재 office 365 구독자에 대해 사용할 수 있습니다. Office 2016 또는 이전 정품 라이선스를 구입한 사용자 현재 없는 공동 기능에 액세스할 수 있습니다. (Excel Online Excel for Android, ios의 경우 Excel 및 Excel Mobile Windows 저장소에도 지원 자동 저장) 합니다. 
