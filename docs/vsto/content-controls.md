...
-   데이터 소스에 대한 데이터 바인딩.  자세한 내용은 [콘텐츠 컨트롤에 데이터 바인딩](#DataBinding)을 참조하세요.  
 ...
 ![비디오에 링크](~/docs/data-tools/media/playvideo.gif "비디오에 링크") 관련 동영상 데모를 보려면 [Visual Studio Tools for Office System\(3.0\)을 사용하여 Word 2007 콘텐츠 컨트롤에 데이터 바인딩](http://go.microsoft.com/fwlink/?LinkId=136785)\(영문\)을 참조하세요.  
