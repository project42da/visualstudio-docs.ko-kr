...
|[&#60;entryPoint&#62; 요소 &#40;Visual Studio에서 Office 개발&#41;](../vsto/entrypoint-element-office-development-in-visual-studio.md)|필수. Office 솔루션에서 실행하는 어셈블리를 식별합니다.|`class`<br /><br /> `contract`|  
|[&#60;업데이트&#62; 요소 &#40;Visual Studio에서 Office 개발&#41;](../vsto/update-element-office-development-in-visual-studio.md)|필수. 솔루션에 대한 업데이트를 구성합니다.|`enabled`<br /><br /> `expiration`|  
