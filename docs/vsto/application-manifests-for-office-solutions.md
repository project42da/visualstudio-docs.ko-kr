...
|요소|설명|특성|  
|-------------|-----------------|----------------|  
|[&#60; customHostSpecified &#62; 요소 &#40; Visual Studio &#41;에서 Office 개발](../vsto/customhostspecified-element-office-development-in-visual-studio.md)|필수. 매니페스트를 특별히 Office 솔루션으로 표시합니다.|없음|  
|[&#60; 추가 기능 &#62; 요소 &#40; Visual Studio &#41;에서 Office 개발](../vsto/addin-element-office-development-in-visual-studio.md)|필수. 진입점을 단일 네임스페이스에 저장합니다.|없음|  
|[&#60; entryPointsCollection &#62; 요소 &#40; Visual Studio &#41;에서 Office 개발](../vsto/entrypointscollection-element-office-development-in-visual-studio.md)|필수. 하나 이상의 Office 솔루션에 대한 모든 어셈블리를 그룹화합니다.|`id`|  
|[&#60; 진입점 &#62; 요소 &#40; Visual Studio &#41;에서 Office 개발](../vsto/entrypoints-element-office-development-in-visual-studio.md)|필수. Office 솔루션을 실행하는 모든 어셈블리를 그룹화합니다.|없음|  
|[&#60; entryPoint &#62; 요소 &#40; Visual Studio &#41;에서 Office 개발](../vsto/entrypoint-element-office-development-in-visual-studio.md)|필수. Office 솔루션에서 실행하는 어셈블리를 식별합니다.|`class`<br /><br /> `contract`|  
|[&#60; update&#62; 요소 &#40; Visual Studio &#41;에서 Office 개발](../vsto/update-element-office-development-in-visual-studio.md)|필수. 솔루션에 대한 업데이트를 구성합니다.|`enabled`<br /><br /> `expiration`|  
...
|[&#60; 응용 프로그램 &#62; 요소 &#40; Visual Studio &#41;에서 Office 개발](../vsto/application-element-office-development-in-visual-studio.md)|필수. 응용 프로그램 관련 정보를 단일 노드에 래핑합니다.|없음|  
|[&#60; 사용자 지정 &#62; 요소 &#40; Visual Studio &#41;에서 Office 개발](../vsto/customizations-element-office-development-in-visual-studio.md)|필수. 별도의 네임스페이스에 모든 응용 프로그램 호스트 관련 정보를 저장합니다.|없음|  
|[&#60; 사용자 지정 &#62; 요소 &#40; Visual Studio &#41;에서 Office 개발](../vsto/customization-element-office-development-in-visual-studio.md)|필수. 별도의 네임스페이스에 응용 프로그램 호스트 관련 정보를 저장합니다.|`xmlns`|  
...
|[&#60; m e &#62; 요소 &#40; Visual Studio &#41;에서 Office 개발](../vsto/vstoruntime-element-office-development-in-visual-studio.md)|필수. Office 솔루션에서 지원되는 Visual Studio Tools for Office Runtime의 특정 버전을 설명합니다.|`release`<br /><br /> `version`<br /><br /> `supportUrl`|  
