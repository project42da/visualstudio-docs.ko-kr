...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "Outlook[Visual Studio에서 Office 개발], 연락처"
  - "연락처[Visual Studio에서 Office 개발], 연락처 정보"
  - "메일[Visual Studio에서 Office 개발], 연락처"
  - "연락처[Visual Studio에서 Office 개발]"
...
|새 연락처를 만들고 연락처 정보를 입력합니다.|[방법: 프로그래밍 방식으로 Outlook 연락처에 엔트리 추가](../vsto/how-to-programmatically-add-an-entry-to-outlook-contacts.md)|  
...
|지정한 이름을 가진 연락처를 삭제합니다.|[방법: 프로그래밍 방식으로 Outlook 연락처 삭제](../vsto/how-to-programmatically-delete-outlook-contacts.md)|  
 ...
 Outlook 작업 및 Outlook 개체 모델에 대한 자세한 내용은 [Outlook 개체 모델 개요](../vsto/outlook-object-model-overview.md)를 참조하세요.  
