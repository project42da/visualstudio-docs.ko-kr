...
## <a name="deploying-a-solution-by-using-clickonce"></a>ClickOnce를 사용하여 솔루션 배포  
...
## <a name="deploying-a-solution-by-using-windows-installer"></a>Windows Installer를 사용하여 솔루션 배포  
