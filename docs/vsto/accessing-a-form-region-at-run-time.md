...
### <a name="imported-form-regions"></a>가져온 양식 영역  
 ...
 C#에서 속성을 만드는 방법에 대 한 자세한 내용은 참조 [하는 방법: 선언 하 고 사용 하 여 쓰기 속성을 읽을 &#40;C&#35; 프로그래밍 가이드&#41;](/dotnet/csharp/programming-guide/classes-and-structs/how-to-declare-and-use-read-write-properties)합니다.  
