...
-   `pDesc`에서 전달된 `D3D11_TEXTURE2D_DESC` 개체가 렌더링 대상을 설명하는 경우, 즉 다음과 같은 경우입니다.  
  
    -   BindFlags 멤버에는 D3D11\_BIND\_TARGET 플래그 또는 D3D11\_BIND\_DEPTH\_STENCIL 플래그 집합이 있습니다.  
