...
최신 버전의 [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] 에 대 한 새로운 기능을 제공 [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] 디버깅 합니다. 디버깅 하려면 [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] 소스, 디버깅 코드에 대 한 기호에 대 한 액세스 권한이 있어야 합니다. 한 단계씩 실행 해야 [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] 소스입니다.  
 ...
 사용 하도록 설정할 수 [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] 단계별 실행 및 기호 다운로드에 **옵션** 대화 상자. 기호 다운로드를 설정할 때 기호를 즉시 다운로드할 수도 있고 나중에 다운로드하도록 옵션만 설정해 놓을 수도 있습니다. 기호를 즉시 다운로드하지 않으면 기호는 다음 번에 응용 프로그램 디버깅을 시작할 때 다운로드됩니다. 다운로드 하 여 수동으로 수행할 수는 **모듈** 창 또는 **호출 스택** 창.  
...
3.  에 **일반** 상자에서 설정 **.NET Framework를 사용 하도록 설정** 소스 단계별 실행 합니다.  
...
5.  기호 캐시 위치를 변경하려면:  
    ...
    1.  열기는 **디버깅** 왼쪽 상자에서 노드.  
  
    2.  아래는 **디버깅** 노드를 클릭 하 여 **기호**합니다.  
  
    3.  위치를 편집 **기호 서버에서이 디렉터리로 기호 캐시** 키를 누르거나 **찾아보기** 위치를 선택 합니다.  
...
1.  에 **모듈** 창에서 기호가 로드 되지 않은 모듈 마우스 오른쪽 단추로 클릭 합니다. 확인할 수 있습니다 기호가 로드 되었는지 확인 하 여 하지는 **기호 상태** 열입니다.  
  
2.  가리킨 **에서 기호 로드** 클릭 **Microsoft 기호 서버** Microsoft 공용 기호 서버에서 기호를 다운로드 하려면 또는 **기호 경로** 디렉터리에서 로드 하지 이전에 저장 한 기호입니다.  
...
2.  가리킨 **에서 기호 로드** 클릭 **Microsoft 기호 서버** 또는 **기호 경로**합니다.  
