...
|[관리 코드를 디버깅](../debugger/debugging-managed-code.md)|관리 코드(Visual C#, Visual Basic 및 F3)를 디버그하는 방법을 설명합니다.|  
...
|[웹 응용 프로그램 디버깅](../debugger/debugging-web-applications.md)|웹 응용 프로그램 및 스크립트를 디버깅 하는 방법에 설명 합니다.|  
