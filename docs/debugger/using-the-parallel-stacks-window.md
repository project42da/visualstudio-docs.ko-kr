...
|-|-|  
|아이콘|설명|  
|![병렬 스택 노란색 화살표](../debugger/media/icon_parallelyellowarrow.png "Icon\_ParallelYellowArrow")|메서드 컨텍스트에 현재 스레드의 활성 스택 프레임이 포함되어 있음을 나타냅니다.|  
|![병렬 스택 스레드 아이콘](../debugger/media/icon_parallelthreads.png "Icon\_ParallelThreads")|메서드 컨텍스트에 현재 스레드가 아닌 스레드의 활성 스택 프레임이 포함되어 있음을 나타냅니다.|  
|![병렬 스택 녹색 화살표](../debugger/media/icon_parallelgreenarrow.png "Icon\_ParallelGreenArrow")|메서드 컨텍스트에 현재 스택 프레임이 포함되어 있음을 나타냅니다.  메서드 이름이 나타나는 모든 노드에서 메서드 이름이 굵게 표시됩니다.|  
