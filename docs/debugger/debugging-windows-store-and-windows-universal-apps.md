---
title: "UWP 및 Windows 8.1 앱 디버깅 | Microsoft Docs"
ms.custom: 
ms.date: 07/18/2017
ms.reviewer: 
ms.suite: 
...
유니버설 Windows 앱을 디버깅 하는 방법에 대 한 정보를 참조 하십시오. [배포 및 디버깅 UWP 앱](/windows/uwp/debug-test-perf/deploying-and-debugging-uwp-apps)합니다.  
