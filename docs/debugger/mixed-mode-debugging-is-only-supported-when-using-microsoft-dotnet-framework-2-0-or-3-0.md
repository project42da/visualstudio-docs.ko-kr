---
title: "혼합 모드 디버깅은 Microsoft .NET Framework 2.0 또는 3.0을 사용할 때만 지원됩니다. | Microsoft Docs"
ms.custom: ""
ms.date: "12/03/2016"
...
manager: "ghogen"
---
# 혼합 모드 디버깅은 Microsoft .NET Framework 2.0 또는 3.0을 사용할 때만 지원됩니다.
...
### 운영 체제를 32비트로 변경하려면\(Visual Basic 또는 C\#\)  
...
### 운영 체제를 32비트로 변경하려면\(C\/C\+\+\)  
  
1.  **솔루션 탐색기**에서 프로젝트를 마우스 오른쪽 단추로 클릭한 다음 바로 가기 메뉴에서 **속성**을 클릭합니다.  
  
     속성 페이지에서 **플랫폼**을 클릭한 다음 플랫폼 목록에서 **Win32**를 선택합니다.  
