...
1. Visual Studio에서 웹 배포 된 응용 프로그램을 배포 하려는 경우 서버에서 최신 버전의 웹 배포를 설치 합니다.
    ...
    웹 배포를 설치 하려면 사용 된 [웹 플랫폼 설치 관리자 (WebPI)](https://www.microsoft.com/web/downloads/platform.aspx)합니다. 응용 프로그램 탭에서 웹 배포을 찾습니다. 설치 관리자에서 직접 가져올 수도 있습니다는 [Microsoft 다운로드 센터](https://www.microsoft.com/search/result.aspx?q=webdeploy&form=dlc)합니다. 
