...
|[방법: WPF 추적 정보 표시](../debugger/how-to-display-wpf-trace-information.md)|[!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]에서는 WPF 응용 프로그램에서 디버그 추적 정보를 받아서 **출력** 창에 표시할 수 있습니다.  이 항목에서는 WPF 추적 정보를 표시하도록 설정하고 표시를 사용자 지정하는 방법을 보여 줍니다.|  
