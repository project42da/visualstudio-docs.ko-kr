...
## <a name="in-this-section"></a>단원 내용  
 ...
 [디버거는 비디오를 시청 하세요](../debugger/getting-started-with-the-debugger.md#video)  
 응용 프로그램을 디버깅 하려면 디버거 기능을 사용 하는 방법을 보여 줍니다.
 ...
 [시각화 도우미에서 문자열 값을 볼](string-visualizer-dialog-box.md) 를 디버깅 하는 동안 문자열 값을 보는 방법을 설명 합니다.
  
 [내 코드만 사용 하 여 사용자 코드를 디버그 합니다.](../debugger/just-my-code.md)  
