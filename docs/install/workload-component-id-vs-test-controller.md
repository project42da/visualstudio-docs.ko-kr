---
title:
- "Visual Studio Test Controller 2017 작업 및 구성 요소 ID | Microsoft Docs"
...
구성 요소 ID | 이름 | 종속성 유형
--- | --- | ---
Microsoft.VisualStudio.ComponentGroup.TestTools.TestController | Test Controller 핵심 기능 | 필수
