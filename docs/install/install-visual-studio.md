...
> [!TIP]
>  설치 후에 언제든지 초기에 설치하지 않은 워크로드 또는 구성 요소를 설치할 수 있습니다. Visual Studio가 열려 있으면 **도구**, **도구 및 기능 가져오기...**로 차례로 이동하여 Visual Studio 설치 관리자를 엽니다. 또는 [시작] 메뉴에서 **Visual Studio 설치 관리자**를 엽니다. 여기서 설치하려는 워크로드 또는 구성 요소를 선택한 다음 **수정**을 클릭합니다.  
