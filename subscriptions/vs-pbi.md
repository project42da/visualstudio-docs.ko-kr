...
---
# <a name="activating-the-power-bi-pro-benefit-in-visual-studio-subscriptions"></a>Visual Studio 구독에서 Power BI Pro 혜택 활성화

Office 및 SharePoint용 추가 기능을 개발, 테스트 및 배포합니다.  단일 테넌트 SharePoint Online 개발자 사이트가 포함되어 있습니다. 

Power BI Pro를 사용하려면 기존 계정을 사용하여 계정을 설정하거나 로그인해야 합니다. 
1.  혜택 타일의 아래쪽에 있는 **코드 가져오기** 링크를 클릭합니다.   코드가 성공적으로 검색되었다는 알림 메시지를 받게 됩니다.  **활성화**를 클릭합니다. 
