...
# 개요
## [구독 옵션 비교](compare-subscriptions.md)

# 방법 가이드
##  구독자
### [구독 구매](buy-vs-subscriptions.md)
### [구독 관리](manage-vs-subscriptions.md)
### [구독자 다운로드 사용](subscriber-downloads.md)
...
##### [Office 365 개발자](vs-office-dev.md)
...
### [과도하게 청구된 구독 처리](handle-overclaimed-license.md)
### [만료된 구독 처리](handle-expired-license.md)

## 리소스
### [사용 약관](vs-license-terms.md)
### [구독 지원](https://www.visualstudio.com/subscriptions/support/)
