...
| Microsoft Certified Trainer - 소프트웨어 및 서비스                             | Included              |  예                                                               |
...
1. [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs)를 방문하여 구독자 포털에 로그인합니다.
...
4. 도구 섹션에서 Office 365 개발자 구독 타일을 찾습니다.  혜택 타일의 아래쪽에 있는 **코드 얻기** 링크를 클릭합니다.   코드가 검색되면 **활성화**를 클릭합니다. 
